...
void main() {
	...
	#include <colorspace_fragment>
	#include <fog_fragment>
}`},$={common:{diffuse:{value:new Y(16777215)},opacity:{value:1},map:{value:null},mapTransform:{value:new q},alphaMap:{value:null},alphaMapTransform:{value:new q},alphaTest:{value:0}},specularmap:{specularMap:{value:null},specularMapTransform:{value:new q}},envmap:{envMap:{value:null},envMapRotation:{value:new q},reflectivity:{value:1},ior:{value:1.5},refractionRatio:{value:.98},dfgLUT:{value:null}},aomap:{aoMap:{value:null},aoMapIntensity:{value:1},aoMapTransform:{value:new q}},lightmap:{lightMap:{value:null},lightMapIntensity:{value:1},lightMapTransform:{value:new q}},bumpmap:{bumpMap:{value:null},bumpMapTransform:{value:new q},bumpScale:{value:1}},normalmap:{normalMap:{value:null},normalMapTransform:{value:new q},normalScale:{value:new G(1,1)}},displacementmap:{displacementMap:{value:null},displacementMapTransform:{value:new q},displacementScale:{value:1},displacementBias:{value:0}},emissivemap:{emissiveMap:{value:null},emissiveMapTransform:{value:new q}},metalnessmap:{metalnessMap:{value:null},metalnessMapTransform:{value:new q}},roughnessmap:{roughnessMap:{value:null},roughnessMapTransform:{value:new q}},gradientmap:{gradientMap:{value:null}},fog:{fogDensity:{value:25e-5},fogNear:{value:1},fogFar:{value:2e3},fogColor:{value:new Y(16777215)}},lights:{ambientLightColor:{value:[]},lightProbe:{value:[]},directionalLights:{value:[],properties:{direction:{},color:{}}},directionalLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},directionalShadowMatrix:{value:[]},spotLights:{value:[],properties:{color:{},position:{},direction:{},distance:{},coneCos:{},penumbraCos:{},decay:{}}},spotLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},spotLightMap:{value:[]},spotLightMatrix:{value:[]},pointLights:{value:[],properties:{color:{},position:{},decay:{},distance:{}}},pointLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{},shadowCameraNear:{},shadowCameraFar:{}}},pointShadowMatrix:{value:[]},hemisphereLights:{value:[],properties:{direction:{},skyColor:{},groundColor:{}}},rectAreaLights:{value:[],properties:{color:{},position:{},width:{},height:{}}},ltc_1:{value:null},ltc_2:{value:null},probesSH:{value:null},probesMin:{value:new K},probesMax:{value:new K},probesResolution:{value:new K}},points:{diffuse:{value:new Y(16777215)},opacity:{value:1},size:{value:1},scale:{value:1},map:{value:null},alphaMap:{value:null},alphaMapTransform:{value:new q},alphaTest:{value:0},uvTransform:{value:new q}},sprite:{diffuse:{value:new Y(16777215)},opacity:{value:1},center:{value:new G(.5,.5)},rotation:{value:0},map:{value:null},mapTransform:{value:new q},alphaMap:{value:null},alphaMapTransform:{value:new q},alphaTest:{value:0}}},ns={basic:{uniforms:za([$.common,$.specularmap,$.envmap,$.aomap,$.lightmap,$.fog]),vertexShader:Q.meshbasic_vert,fragmentShader:Q.meshbasic_frag},lambert:{uniforms:za([$.common,$.specularmap,$.envmap,$.aomap,$.lightmap,$.emissivemap,$.bumpmap,$.normalmap,$.displacementmap,$.fog,$.lights,{emissive:{value:new Y(0)},envMapIntensity:{value:1}}]),vertexShader:Q.meshlambert_vert,fragmentShader:Q.meshlambert_frag},phong:{uniforms:za([$.common,$.specularmap,$.envmap,$.aomap,$.lightmap,$.emissivemap,$.bumpmap,$.normalmap,$.displacementmap,$.fog,$.lights,{emissive:{value:new Y(0)},specular:{value:new Y(1118481)},shininess:{value:30},envMapIntensity:{value:1}}]),vertexShader:Q.meshphong_vert,fragmentShader:Q.meshphong_frag},standard:{uniforms:za([$.common,$.envmap,$.aomap,$.lightmap,$.emissivemap,$.bumpmap,$.normalmap,$.displacementmap,$.roughnessmap,$.metalnessmap,$.fog,$.lights,{emissive:{value:new Y(0)},roughness:{value:1},metalness:{value:0},envMapIntensity:{value:1}}]),vertexShader:Q.meshphysical_vert,fragmentShader:Q.meshphysical_frag},toon:{uniforms:za([$.common,$.aomap,$.lightmap,$.emissivemap,$.bumpmap,$.normalmap,$.displacementmap,$.gradientmap,$.fog,$.lights,{emissive:{value:new Y(0)}}]),vertexShader:Q.meshtoon_vert,fragmentShader:Q.meshtoon_frag},matcap:{uniforms:za([$.common,$.bumpmap,$.normalmap,$.displacementmap,$.fog,{matcap:{value:null}}]),vertexShader:Q.meshmatcap_vert,fragmentShader:Q.meshmatcap_frag},points:{uniforms:za([$.points,$.fog]),vertexShader:Q.points_vert,fragmentShader:Q.points_frag},dashed:{uniforms:za([$.common,$.fog,{scale:{value:1},dashSize:{value:1},totalSize:{value:2}}]),vertexShader:Q.linedashed_vert,fragmentShader:Q.linedashed_frag},depth:{uniforms:za([$.common,$.displacementmap]),vertexShader:Q.depth_vert,fragmentShader:Q.depth_frag},normal:{uniforms:za([$.common,$.bumpmap,$.normalmap,$.displacementmap,{opacity:{value:1}}]),vertexShader:Q.meshnormal_vert,fragmentShader:Q.meshnormal_frag},sprite:{uniforms:za([$.sprite,$.fog]),vertexShader:Q.sprite_vert,fragmentShader:Q.sprite_frag},background:{uniforms:{uvTransform:{value:new q},t2D:{value:null},backgroundIntensity:{value:1}},vertexShader:Q.background_vert,fragmentShader:Q.background_frag},backgroundCube:{uniforms:{envMap:{value:null},backgroundBlurriness:{value:0},backgroundIntensity:{value:1},backgroundRotation:{value:new q}},vertexShader:Q.backgroundCube_vert,fragmentShader:Q.backgroundCube_frag},cube:{uniforms:{tCube:{value:null},tFlip:{value:-1},opacity:{value:1}},vertexShader:Q.cube_vert,fragmentShader:Q.cube_frag},equirect:{uniforms:{tEquirect:{value:null}},vertexShader:Q.equirect_vert,fragmentShader:Q.equirect_frag},distance:{uniforms:za([$.common,$.displacementmap,{referencePosition:{value:new K},nearDistance:{value:1},farDistance:{value:1e3}}]),vertexShader:Q.distance_vert,fragmentShader:Q.distance_frag},shadow:{uniforms:za([$.lights,$.fog,{color:{value:new Y(0)},opacity:{value:1}}]),vertexShader:Q.shadow_vert,fragmentShader:Q.shadow_frag}};ns.physical={uniforms:za([ns.standard.uniforms,{clearcoat:{value:0},clearcoatMap:{value:null},clearcoatMapTransform:{value:new q},clearcoatNormalMap:{value:null},clearcoatNormalMapTransform:{value:new q},clearcoatNormalScale:{value:new G(1,1)},clearcoatRoughness:{value:0},clearcoatRoughnessMap:{value:null},clearcoatRoughnessMapTransform:{value:new q},dispersion:{value:0},iridescence:{value:0},iridescenceMap:{value:null},iridescenceMapTransform:{value:new q},iridescenceIOR:{value:1.3},iridescenceThicknessMinimum:{value:100},iridescenceThicknessMaximum:{value:400},iridescenceThicknessMap:{value:null},iridescenceThicknessMapTransform:{value:new q},sheen:{value:0},sheenColor:{value:new Y(0)},sheenColorMap:{value:null},sheenColorMapTransform:{value:new q},sheenRoughness:{value:1},sheenRoughnessMap:{value:null},sheenRoughnessMapTransform:{value:new q},transmission:{value:0},transmissionMap:{value:null},transmissionMapTransform:{value:new q},transmissionSamplerSize:{value:new G},transmissionSamplerMap:{value:null},thickness:{value:0},thicknessMap:{value:null},thicknessMapTransform:{value:new q},attenuationDistance:{value:0},attenuationColor:{value:new Y(0)},specularColor:{value:new Y(1,1,1)},specularColorMap:{value:null},specularColorMapTransform:{value:new q},specularIntensity:{value:1},specularIntensityMap:{value:null},specularIntensityMapTransform:{value:new q},anisotropyVector:{value:new G},anisotropyMap:{value:null},anisotropyMapTransform:{value:new q}}]),vertexShader:Q.meshphysical_vert,fragmentShader:Q.meshphysical_frag};var rs={r:0,b:0,g:0},is=new Jt,as=new q;as.set(-1,0,0,0,1,0,0,0,1);function os(e,t,n,r,i,a){let o=new Y(0),s=i===!0?0:1,c,l,u=null,d=0,f=null;function p(e){let n=e.isScene===!0?e.background:null;if(n&&n.isTexture){let r=e.backgroundBlurriness>0;n=t.get(n,r)}return n}function m(t){let r=!1,i=p(t);i===null?g(o,s):i&&i.isColor&&(g(i,1),r=!0);let c=e.xr.getEnvironmentBlendMode();c===`additive`?n.buffers.color.setClear(0,0,0,1,a):c===`alpha-blend`&&n.buffers.color.setClear(0,0,0,0,a),(e.autoClear||r)&&(n.buffers.depth.setTest(!0),n.buffers.depth.setMask(!0),n.buffers.color.setMask(!0),e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil))}function h(t,n){let i=p(n);i&&(i.isCubeTexture||i.mapping===306)?(l===void 0&&(l=new Z(new li(1,1,1),new Ka({name:`BackgroundCubeMaterial`,uniforms:Ra(ns.backgroundCube.uniforms),vertexShader:ns.backgroundCube.vertexShader,fragmentShader:ns.backgroundCube.fragmentShader,side:1,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),l.geometry.deleteAttribute(`normal`),l.geometry.deleteAttribute(`uv`),l.onBeforeRender=function(e,t,n){this.matrixWorld.copyPosition(n.matrixWorld)},Object.defineProperty(l.material,"envMap",{get:function(){return this.uniforms.envMap.value}}),r.update(l)),l.material.uniforms.envMap.value=i,l.material.uniforms.backgroundBlurriness.value=n.backgroundBlurriness,l.material.uniforms.backgroundIntensity.value=n.backgroundIntensity,l.material.uniforms.backgroundRotation.value.setFromMatrix4(is.makeRotationFromEuler(n.backgroundRotation)).transpose(),i.isCubeTexture&&i.isRenderTargetTexture===!1&&l.material.uniforms.backgroundRotation.value.premultiply(as),l.material.toneMapped=J.getTransfer(i.colorSpace)!==ze,(u!==i||d!==i.version||f!==e.toneMapping)&&(l.material.needsUpdate=!0,u=i,d=i.version,f=e.toneMapping),l.layers.enableAll(),t.unshift(l,l.geometry,l.material,0,0,null)):i&&i.isTexture&&(c===void 0&&(c=new Z(new Na(2,2),new Ka({name:`BackgroundMaterial`,uniforms:Ra(ns.background.uniforms),vertexShader:ns.background.vertexShader,fragmentShader:ns.background.fragmentShader,side:0,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),c.geometry.deleteAttribute(`normal`),Object.defineProperty(c.material,"map",{get:function(){return this.uniforms.t2D.value}}),r.update(c)),c.material.uniforms.t2D.value=i,c.material.uniforms.backgroundIntensity.value=n.backgroundIntensity,c.material.toneMapped=J.getTransfer(i.colorSpace)!==ze,i.matrixAutoUpdate===!0&&i.updateMatrix(),c.material.uniforms.uvTransform.value.copy(i.matrix),(u!==i||d!==i.version||f!==e.toneMapping)&&(c.material.needsUpdate=!0,u=i,d=i.version,f=e.toneMapping),c.layers.enableAll(),t.unshift(c,c.geometry,c.material,0,0,null))}function g(t,r){t.getRGB(rs,Ha(e)),n.buffers.color.setClear(rs.r,rs.g,rs.b,r,a)}function _(){l!==void 0&&(l.geometry.dispose(),l.material.dispose(),l=void 0),c!==void 0&&(c.geometry.dispose(),c.material.dispose(),c=void 0)}return{getClearColor:function(){return o},setClearColor:function(e,t=1){o.set(e),s=t,g(o,s)},getClearAlpha:function(){return s},setClearAlpha:function(e){s=e,g(o,s)},render:m,addToRenderList:h,dispose:_}}function ss(e,t){let n=e.getParameter(e.MAX_VERTEX_ATTRIBS),r={},i=f(null),a=i,o=!1;function s(n,r,i,s,c){let u=!1,f=d(n,s,i,r);a!==f&&(a=f,l(a.object)),u=p(n,s,i,c),u&&m(n,s,i,c),c!==null&&t.update(c,e.ELEMENT_ARRAY_BUFFER),(u||o)&&(o=!1,b(n,r,i,s),c!==null&&e.bindBuffer(e.ELEMENT_ARRAY_BUFFER,t.get(c).buffer))}function c(){return e.createVertexArray()}function l(t){return e.bindVertexArray(t)}function u(t){return e.deleteVertexArray(t)}function d(e,t,n,i){let a=i.wireframe===!0,o=r[t.id];o===void 0&&(o={},r[t.id]=o);let s=e.isInstancedMesh===!0?e.id:0,l=o[s];l===void 0&&(l={},o[s]=l);let u=l[n.id];u===void 0&&(u={},l[n.id]=u);let d=u[a];return d===void 0&&(d=f(c()),u[a]=d),d}function f(e){let t=[],r=[],i=[];for(let e=0;e<n;e++)t[e]=0,r[e]=0,i[e]=0;return{geometry:null,program:null,wireframe:!1,newAttributes:t,enabledAttributes:r,attributeDivisors:i,object:e,attributes:{},index:null}}function p(e,t,n,r){let i=a.attributes,o=t.attributes,s=0,c=n.getAttributes();for(let t in c)if(c[t].location>=0){let n=i[t],r=o[t];if(r===void 0&&(t===`instanceMatrix`&&e.instanceMatrix&&(r=e.instanceMatrix),t===`instanceColor`&&e.instanceColor&&(r=e.instanceColor)),n===void 0||n.attribute!==r||r&&n.data!==r.data)return!0;s++}return a.attributesNum!==s||a.index!==r}function m(e,t,n,r){let i={},o=t.attributes,s=0,c=n.getAttributes();for(let t in c)if(c[t].location>=0){let n=o[t];n===void 0&&(t===`instanceMatrix`&&e.instanceMatrix&&(n=e.instanceMatrix),t===`instanceColor`&&e.instanceColor&&(n=e.instanceColor));let r={};r.attribute=n,n&&n.data&&(r.data=n.data),i[t]=r,s++}a.attributes=i,a.attributesNum=s,a.index=r}function h(){let e=a.newAttributes;for(let t=0,n=e.length;t<n;t++)e[t]=0}function g(e){_(e,0)}function _(t,n){let r=a.newAttributes,i=a.enabledAttributes,o=a.attributeDivisors;r[t]=1,i[t]===0&&(e.enableVertexAttribArray(t),i[t]=1),o[t]!==n&&(e.vertexAttribDivisor(t,n),o[t]=n)}function v(){let t=a.newAttributes,n=a.enabledAttributes;for(let r=0,i=n.length;r<i;r++)n[r]!==t[r]&&(e.disableVertexAttribArray(r),n[r]=0)}function y(t,n,r,i,a,o,s){s===!0?e.vertexAttribIPointer(t,n,r,a,o):e.vertexAttribPointer(t,n,r,i,a,o)}function b(n,r,i,a){h();let o=a.attributes,s=i.getAttributes(),c=r.defaultAttributeValues;for(let r in s){let i=s[r];if(i.location>=0){let s=o[r];if(s===void 0&&(r===`instanceMatrix`&&n.instanceMatrix&&(s=n.instanceMatrix),r===`instanceColor`&&n.instanceColor&&(s=n.instanceColor)),s!==void 0){let r=s.normalized,o=s.itemSize,c=t.get(s);if(c===void 0)continue;let l=c.buffer,u=c.type,d=c.bytesPerElement,f=u===e.INT||u===e.UNSIGNED_INT||s.gpuType===1013;if(s.isInterleavedBufferAttribute){let t=s.data,c=t.stride,p=s.offset;if(t.isInstancedInterleavedBuffer){for(let e=0;e<i.locationSize;e++)_(i.location+e,t.meshPerAttribute);n.isInstancedMesh!==!0&&a._maxInstanceCount===void 0&&(a._maxInstanceCount=t.meshPerAttribute*t.count)}else for(let e=0;e<i.locationSize;e++)g(i.location+e);e.bindBuffer(e.ARRAY_BUFFER,l);for(let e=0;e<i.locationSize;e++)y(i.location+e,o/i.locationSize,u,r,c*d,(p+o/i.locationSize*e)*d,f)}else{if(s.isInstancedBufferAttribute){for(let e=0;e<i.locationSize;e++)_(i.location+e,s.meshPerAttribute);n.isInstancedMesh!==!0&&a._maxInstanceCount===void 0&&(a._maxInstanceCount=s.meshPerAttribute*s.count)}else for(let e=0;e<i.locationSize;e++)g(i.location+e);e.bindBuffer(e.ARRAY_BUFFER,l);for(let e=0;e<i.locationSize;e++)y(i.location+e,o/i.locationSize,u,r,o*d,o/i.locationSize*e*d,f)}}else if(c!==void 0){let t=c[r];if(t!==void 0)switch(t.length){case 2:e.vertexAttrib2fv(i.location,t);break;case 3:e.vertexAttrib3fv(i.location,t);break;case 4:e.vertexAttrib4fv(i.location,t);break;default:e.vertexAttrib1fv(i.location,t)}}}}v()}function x(){T();for(let e in r){let t=r[e];for(let e in t){let n=t[e];for(let e in n){let t=n[e];for(let e in t)u(t[e].object),delete t[e];delete n[e]}}delete r[e]}}function S(e){if(r[e.id]===void 0)return;let t=r[e.id];for(let e in t){let n=t[e];for(let e in n){let t=n[e];for(let e in t)u(t[e].object),delete t[e];delete n[e]}}delete r[e.id]}function C(e){for(let t in r){let n=r[t];for(let t in n){let r=n[t];if(r[e.id]===void 0)continue;let i=r[e.id];for(let e in i)u(i[e].object),delete i[e];delete r[e.id]}}}function w(e){for(let t in r){let n=r[t],i=e.isInstancedMesh===!0?e.id:0,a=n[i];if(a!==void 0){for(let e in a){let t=a[e];for(let e in t)u(t[e].object),delete t[e];delete a[e]}delete n[i],Object.keys(n).length===0&&delete r[t]}}}function T(){E(),o=!0,a!==i&&(a=i,l(a.object))}function E(){i.geometry=null,i.program=null,i.wireframe=!1}return{setup:s,reset:T,resetDefaultState:E,dispose:x,releaseStatesOfGeometry:S,releaseStatesOfObject:w,releaseStatesOfProgram:C,initAttributes:h,enableAttribute:g,disableUnusedAttributes:v}}function cs(e,t,n){let r;function i(e){r=e}function a(t,i){e.drawArrays(r,t,i),n.update(i,r,1)}function o(t,i,a){a!==0&&(e.drawArraysInstanced(r,t,i,a),n.update(i,r,a))}function s(e,i,a){if(a===0)return;t.get(`WEBGL_multi_draw`).multiDrawArraysWEBGL(r,e,0,i,0,a);let o=0;for(let e=0;e<a;e++)o+=i[e];n.update(o,r,1)}this.setMode=i,this.render=a,this.renderInstances=o,this.renderMultiDraw=s}function ls(e,t,n,r){let i;function a(){if(i!==void 0)return i;if(t.has(`EXT_texture_filter_anisotropic`)===!0){let n=t.get(`EXT_texture_filter_anisotropic`);i=e.getParameter(n.MAX_TEXTURE_MAX_ANISOTROPY_EXT)}else i=0;return i}function o(t){return t===1023||r.convert(t)===e.getParameter(e.IMPLEMENTATION_COLOR_READ_FORMAT)}function s(n){let i=n===1016&&(t.has(`EXT_color_buffer_half_float`)||t.has(`EXT_color_buffer_float`));return!(n!==1009&&r.convert(n)!==e.getParameter(e.IMPLEMENTATION_COLOR_READ_TYPE)&&n!==1015&&!i)}function c(t){if(t===`highp`){if(e.getShaderPrecisionFormat(e.VERTEX_SHADER,e.HIGH_FLOAT).precision>0&&e.getShaderPrecisionFormat(e.FRAGMENT_SHADER,e.HIGH_FLOAT).precision>0)return`highp`;t=`mediump`}return t===`mediump`&&e.getShaderPrecisionFormat(e.VERTEX_SHADER,e.MEDIUM_FLOAT).precision>0&&e.getShaderPrecisionFormat(e.FRAGMENT_SHADER,e.MEDIUM_FLOAT).precision>0?`mediump`:`lowp`}let l=n.precision===void 0?`highp`:n.precision,u=c(l);u!==l&&(H(`WebGLRenderer:`,l,`not supported, using`,u,`instead.`),l=u);let d=n.logarithmicDepthBuffer===!0,f=n.reversedDepthBuffer===!0&&t.has(`EXT_clip_control`);n.reversedDepthBuffer===!0&&f===!1&&H(`WebGLRenderer: Unable to use reversed depth buffer due to missing EXT_clip_control extension. Fallback to default depth buffer.`);let p=e.getParameter(e.MAX_TEXTURE_IMAGE_UNITS),m=e.getParameter(e.MAX_VERTEX_TEXTURE_IMAGE_UNITS),h=e.getParameter(e.MAX_TEXTURE_SIZE),g=e.getParameter(e.MAX_CUBE_MAP_TEXTURE_SIZE),_=e.getParameter(e.MAX_VERTEX_ATTRIBS),v=e.getParameter(e.MAX_VERTEX_UNIFORM_VECTORS),y=e.getParameter(e.MAX_VARYING_VECTORS),b=e.getParameter(e.MAX_FRAGMENT_UNIFORM_VECTORS),x=e.getParameter(e.MAX_SAMPLES),S=e.getParameter(e.SAMPLES);return{isWebGL2:!0,getMaxAnisotropy:a,getMaxPrecision:c,textureFormatReadable:o,textureTypeReadable:s,precision:l,logarithmicDepthBuffer:d,reversedDepthBuffer:f,maxTextures:p,maxVertexTextures:m,maxTextureSize:h,maxCubemapSize:g,maxAttributes:_,maxVertexUniforms:v,maxVaryings:y,maxFragmentUniforms:b,maxSamples:x,samples:S}}function us(e){let t=this,n=null,r=0,i=!1,a=!1,o=new $r,s=new q,c={value:null,needsUpdate:!1};this.uniform=c,this.numPlanes=0,this.numIntersection=0,this.init=function(e,t){let n=e.length!==0||t||r!==0||i;return i=t,r=e.length,n},this.beginShadows=function(){a=!0,u(null)},this.endShadows=function(){a=!1},this.setGlobalState=function(e,t){n=u(e,t,0)},this.setState=function(t,o,s){let d=t.clippingPlanes,f=t.clipIntersection,p=t.clipShadows,m=e.get(t);if(!i||d===null||d.length===0||a&&!p)a?u(null):l();else{let e=a?0:r,t=e*4,i=m.clippingState||null;c.value=i,i=u(d,o,t,s);for(let e=0;e!==t;++e)i[e]=n[e];m.clippingState=i,this.numIntersection=f?this.numPlanes:0,this.numPlanes+=e}};function l(){c.value!==n&&(c.value=n,c.needsUpdate=r>0),t.numPlanes=r,t.numIntersection=0}function u(e,n,r,i){let a=e===null?0:e.length,l=null;if(a!==0){if(l=c.value,i!==!0||l===null){let t=r+a*4,i=n.matrixWorldInverse;s.getNormalMatrix(i),(l===null||l.length<t)&&(l=new Float32Array(t));for(let t=0,n=r;t!==a;++t,n+=4)o.copy(e[t]).applyMatrix4(i,s),o.normal.toArray(l,n),l[n+3]=o.constant}c.value=l,c.needsUpdate=!0}return t.numPlanes=a,t.numIntersection=0,l}}var ds=4,fs=[.125,.215,.35,.446,.526,.582],ps=20,ms=256,hs=new Eo,gs=new Y,_s=null,vs=0,ys=0,bs=!1,xs=new K,Ss=class{constructor(e){this._renderer=e,this._pingPongRenderTarget=null,this._lodMax=0,this._cubeSize=0,this._sizeLods=[],this._sigmas=[],this._lodMeshes=[],this._backgroundBox=null,this._cubemapMaterial=null,this._equirectMaterial=null,this._blurMaterial=null,this._ggxMaterial=null}fromScene(e,t=0,n=.1,r=100,i={}){let{size:a=256,position:o=xs}=i;_s=this._renderer.getRenderTarget(),vs=this._renderer.getActiveCubeFace(),ys=this._renderer.getActiveMipmapLevel(),bs=this._renderer.xr.enabled,this._renderer.xr.enabled=!1,this._setSize(a);let s=this._allocateTargets();return s.depthBuffer=!0,this._sceneToCubeUV(e,n,r,s,o),t>0&&this._blur(s,0,0,t),this._applyPMREM(s),this._cleanup(s),s}fromEquirectangular(e,t=null){return this._fromTexture(e,t)}fromCubemap(e,t=null){return this._fromTexture(e,t)}compileCubemapShader(){this._cubemapMaterial===null&&(this._cubemapMaterial=ks(),this._compileMaterial(this._cubemapMaterial))}compileEquirectangularShader(){this._equirectMaterial===null&&(this._equirectMaterial=Os(),this._compileMaterial(this._equirectMaterial))}dispose(){this._dispose(),this._cubemapMaterial!==null&&this._cubemapMaterial.dispose(),this._equirectMaterial!==null&&this._equirectMaterial.dispose(),this._backgroundBox!==null&&(this._backgroundBox.geometry.dispose(),this._backgroundBox.material.dispose())}_setSize(e){this._lodMax=Math.floor(Math.log2(e)),this._cubeSize=2**this._lodMax}_dispose(){this._blurMaterial!==null&&this._blurMaterial.dispose(),this._ggxMaterial!==null&&this._ggxMaterial.dispose(),this._pingPongRenderTarget!==null&&this._pingPongRenderTarget.dispose();for(let e=0;e<this._lodMeshes.length;e++)this._lodMeshes[e].geometry.dispose()}_cleanup(e){this._renderer.setRenderTarget(_s,vs,ys),this._renderer.xr.enabled=bs,e.scissorTest=!1,Ts(e,0,0,e.width,e.height)}_fromTexture(e,t){e.mapping===301||e.mapping===302?this._setSize(e.image.length===0?16:e.image[0].width||e.image[0].image.width):this._setSize(e.image.width/4),_s=this._renderer.getRenderTarget(),vs=this._renderer.getActiveCubeFace(),ys=this._renderer.getActiveMipmapLevel(),bs=this._renderer.xr.enabled,this._renderer.xr.enabled=!1;let n=t||this._allocateTargets();return this._textureToCubeUV(e,n),this._applyPMREM(n),this._cleanup(n),n}_allocateTargets(){let e=3*Math.max(this._cubeSize,112),t=4*this._cubeSize,n={magFilter:c,minFilter:c,generateMipmaps:!1,type:v,format:E,colorSpace:Le,depthBuffer:!1},r=ws(e,t,n);if(this._pingPongRenderTarget===null||this._pingPongRenderTarget.width!==e||this._pingPongRenderTarget.height!==t){this._pingPongRenderTarget!==null&&this._dispose(),this._pingPongRenderTarget=ws(e,t,n);let{_lodMax:r}=this;({lodMeshes:this._lodMeshes,sizeLods:this._sizeLods,sigmas:this._sigmas}=Cs(r)),this._blurMaterial=Ds(r,e,t),this._ggxMaterial=Es(r,e,t)}return r}_compileMaterial(e){let t=new Z(new wr,e);this._renderer.compile(t,hs)}_sceneToCubeUV(e,t,n,r,i){let a=new To(90,1,t,n),o=[1,-1,1,1,1,1],s=[1,1,1,-1,-1,-1],c=this._renderer,l=c.autoClear,u=c.toneMapping;c.getClearColor(gs),c.toneMapping=0,c.autoClear=!1,c.state.buffers.depth.getReversed()&&(c.setRenderTarget(r),c.clearDepth(),c.setRenderTarget(null)),this._backgroundBox===null&&(this._backgroundBox=new Z(new li,new Fr({name:`PMREM.Background`,side:1,depthWrite:!1,depthTest:!1})));let d=this._backgroundBox,f=d.material,p=!1,m=e.background;m?m.isColor&&(f.color.copy(m),e.background=null,p=!0):(f.color.copy(gs),p=!0);for(let t=0;t<6;t++){let n=t%3;n===0?(a.up.set(0,o[t],0),a.position.set(i.x,i.y,i.z),a.lookAt(i.x+s[t],i.y,i.z)):n===1?(a.up.set(0,0,o[t]),a.position.set(i.x,i.y,i.z),a.lookAt(i.x,i.y+s[t],i.z)):(a.up.set(0,o[t],0),a.position.set(i.x,i.y,i.z),a.lookAt(i.x,i.y,i.z+s[t]));let l=this._cubeSize;Ts(r,n*l,t>2?l:0,l,l),c.setRenderTarget(r),p&&c.render(d,a),c.render(e,a)}c.toneMapping=u,c.autoClear=l,e.background=m}_textureToCubeUV(e,t){let n=this._renderer,r=e.mapping===301||e.mapping===302;r?(this._cubemapMaterial===null&&(this._cubemapMaterial=ks()),this._cubemapMaterial.uniforms.flipEnvMap.value=e.isRenderTargetTexture===!1?-1:1):this._equirectMaterial===null&&(this._equirectMaterial=Os());let i=r?this._cubemapMaterial:this._equirectMaterial,a=this._lodMeshes[0];a.material=i;let o=i.uniforms;o.envMap.value=e;let s=this._cubeSize;Ts(t,0,0,3*s,2*s),n.setRenderTarget(t),n.render(a,hs)}_applyPMREM(e){let t=this._renderer,n=t.autoClear;t.autoClear=!1;let r=this._lodMeshes.length;for(let t=1;t<r;t++)this._applyGGXFilter(e,t-1,t);t.autoClear=n}_applyGGXFilter(e,t,n){let r=this._renderer,i=this._pingPongRenderTarget,a=this._ggxMaterial,o=this._lodMeshes[n];o.material=a;let s=a.uniforms,c=n/(this._lodMeshes.length-1),l=t/(this._lodMeshes.length-1),u=Math.sqrt(c*c-l*l)*(0+c*1.25),{_lodMax:d}=this,f=this._sizeLods[n],p=3*f*(n>d-ds?n-d+ds:0),m=4*(this._cubeSize-f);s.envMap.value=e.texture,s.roughness.value=u,s.mipInt.value=d-t,Ts(i,p,m,3*f,2*f),r.setRenderTarget(i),r.render(o,hs),s.envMap.value=i.texture,s.roughness.value=0,s.mipInt.value=d-n,Ts(e,p,m,3*f,2*f),r.setRenderTarget(e),r.render(o,hs)}_blur(e,t,n,r,i){let a=this._pingPongRenderTarget;this._halfBlur(e,a,t,n,r,`latitudinal`,i),this._halfBlur(a,e,n,n,r,`longitudinal`,i)}_halfBlur(e,t,n,r,i,a,o){let s=this._renderer,c=this._blurMaterial;a!==`latitudinal`&&a!==`longitudinal`&&U(`blur direction must be either latitudinal or longitudinal!`);let l=this._lodMeshes[r];l.material=c;let u=c.uniforms,d=this._sizeLods[n]-1,f=isFinite(i)?Math.PI/(2*d):2*Math.PI/39,p=i/f,m=isFinite(i)?1+Math.floor(3*p):ps;m>ps&&H(`sigmaRadians, ${i}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${ps}`);let h=[],g=0;for(let e=0;e<ps;++e){let t=e/p,n=Math.exp(-t*t/2);h.push(n),e===0?g+=n:e<m&&(g+=2*n)}for(let e=0;e<h.length;e++)h[e]=h[e]/g;u.envMap.value=e.texture,u.samples.value=m,u.weights.value=h,u.latitudinal.value=a===`latitudinal`,o&&(u.poleAxis.value=o);let{_lodMax:_}=this;u.dTheta.value=f,u.mipInt.value=_-n;let v=this._sizeLods[r];Ts(t,3*v*(r>_-ds?r-_+ds:0),4*(this._cubeSize-v),3*v,2*v),s.setRenderTarget(t),s.render(l,hs)}};function Cs(e){let t=[],n=[],r=[],i=e,a=e-ds+1+fs.length;for(let o=0;o<a;o++){let a=2**i;t.push(a);let s=1/a;o>e-ds?s=fs[o-e+ds-1]:o===0&&(s=0),n.push(s);let c=1/(a-2),l=-c,u=1+c,d=[l,l,u,l,u,u,l,l,u,u,l,u],f=new Float32Array(108),p=new Float32Array(72),m=new Float32Array(36);for(let e=0;e<6;e++){let t=e%3*2/3-1,n=e>2?0:-1,r=[t,n,0,t+2/3,n,0,t+2/3,n+1,0,t,n,0,t+2/3,n+1,0,t,n+1,0];f.set(r,18*e),p.set(d,12*e);let i=[e,e,e,e,e,e];m.set(i,6*e)}let h=new wr;h.setAttribute(`position`,new ur(f,3)),h.setAttribute(`uv`,new ur(p,2)),h.setAttribute(`faceIndex`,new ur(m,1)),r.push(new Z(h,null)),i>ds&&i--}return{lodMeshes:r,sizeLods:t,sigmas:n}}function ws(e,t,n){let r=new Gt(e,t,n);return r.texture.mapping=306,r.texture.name=`PMREM.cubeUv`,r.scissorTest=!0,r}function Ts(e,t,n,r,i){e.viewport.set(t,n,r,i),e.scissor.set(t,n,r,i)}function Es(e,t,n){return new Ka({name:`PMREMGGXConvolution`,defines:{GGX_SAMPLES:ms,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},roughness:{value:0},mipInt:{value:0}},vertexShader:As(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ds(e,t,n){let r=new Float32Array(ps),i=new K(0,1,0);return new Ka({name:`SphericalGaussianBlur`,defines:{n:ps,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:As(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Os(){return new Ka({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:As(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ks(){return new Ka({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:As(),fragmentShader:`
	...
	`}var js=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ii(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),u=new Z(c,l),d=new Eo(-1,1,1,-1,0,1),f=null,p=null,m=!1,h,g=null,_=[],y=!1;this.setSize=function(e,t){o.setSize(e,t),s.setSize(e,t);for(let n=0;n<_.length;n++){let r=_[n];r.setSize&&r.setSize(e,t)}},this.setEffects=function(e){_=e,y=_.length>0&&_[0].isRenderPass===!0;let t=o.width,n=o.height;for(let e=0;e<_.length;e++){let r=_[e];r.setSize&&r.setSize(t,n)}},this.begin=function(e,t){if(m||e.toneMapping===0&&_.length===0)return!1;if(g=t,t!==null){let e=t.width,n=t.height;(o.width!==e||o.height!==n)&&this.setSize(e,n)}return y===!1&&e.setRenderTarget(o),h=e.toneMapping,e.toneMapping=0,!0},this.hasRenderPass=function(){return y},this.end=function(e,t){e.toneMapping=h,m=!0;let n=o,r=s;for(let i=0;i<_.length;i++){let a=_[i];if(a.enabled!==!1&&(a.render(e,r,n,t),a.needsSwap!==!1)){let e=n;n=r,r=e}}if(f!==e.outputColorSpace||p!==e.toneMapping){f=e.outputColorSpace,p=e.toneMapping,l.defines={},J.getTransfer(f)===`srgb`&&(l.defines.SRGB_TRANSFER=``);let t=zs[p];t&&(l.defines[t]=``),l.needsUpdate=!0}l.uniforms.tDiffuse.value=n.texture,e.setRenderTarget(g),e.render(u,d),g=null,m=!1},this.isCompositing=function(){return m},this.dispose=function(){o.depthTexture&&o.depthTexture.dispose(),o.dispose(),s.dispose(),c.dispose(),l.dispose()}}var Vs=new Ht,Hs=new oi(1,1),Us=new Kt,Ws=new qt,Gs=new ii,Ks=[],qs=[],Js=new Float32Array(16),Ys=new Float32Array(9),Xs=new Float32Array(4);function Zs(e,t,n){let r=e[0];if(r<=0||r>0)return e;let i=t*n,a=Ks[i];if(a===void 0&&(a=new Float32Array(i),Ks[i]=a),t!==0){r.toArray(a,0);for(let r=1,i=0;r!==t;++r)i+=n,e[r].toArray(a,i)}return a}function Qs(e,t){if(e.length!==t.length)return!1;for(let n=0,r=e.length;n<r;n++)if(e[n]!==t[n])return!1;return!0}function $s(e,t){for(let n=0,r=t.length;n<r;n++)e[n]=t[n]}function ec(e,t){let n=qs[t];n===void 0&&(n=new Int32Array(t),qs[t]=n);for(let r=0;r!==t;++r)n[r]=e.allocateTextureUnit();return n}function tc(e,t){let n=this.cache;n[0]!==t&&(e.uniform1f(this.addr,t),n[0]=t)}function nc(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(e.uniform2f(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(Qs(n,t))return;e.uniform2fv(this.addr,t),$s(n,t)}}function rc(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(e.uniform3f(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else if(t.r!==void 0)(n[0]!==t.r||n[1]!==t.g||n[2]!==t.b)&&(e.uniform3f(this.addr,t.r,t.g,t.b),n[0]=t.r,n[1]=t.g,n[2]=t.b);else{if(Qs(n,t))return;e.uniform3fv(this.addr,t),$s(n,t)}}function ic(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(e.uniform4f(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(Qs(n,t))return;e.uniform4fv(this.addr,t),$s(n,t)}}function ac(e,t){let n=this.cache,r=t.elements;if(r===void 0){if(Qs(n,t))return;e.uniformMatrix2fv(this.addr,!1,t),$s(n,t)}else{if(Qs(n,r))return;Xs.set(r),e.uniformMatrix2fv(this.addr,!1,Xs),$s(n,r)}}function oc(e,t){let n=this.cache,r=t.elements;if(r===void 0){if(Qs(n,t))return;e.uniformMatrix3fv(this.addr,!1,t),$s(n,t)}else{if(Qs(n,r))return;Ys.set(r),e.uniformMatrix3fv(this.addr,!1,Ys),$s(n,r)}}function sc(e,t){let n=this.cache,r=t.elements;if(r===void 0){if(Qs(n,t))return;e.uniformMatrix4fv(this.addr,!1,t),$s(n,t)}else{if(Qs(n,r))return;Js.set(r),e.uniformMatrix4fv(this.addr,!1,Js),$s(n,r)}}function cc(e,t){let n=this.cache;n[0]!==t&&(e.uniform1i(this.addr,t),n[0]=t)}function lc(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(e.uniform2i(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(Qs(n,t))return;e.uniform2iv(this.addr,t),$s(n,t)}}function uc(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(e.uniform3i(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else{if(Qs(n,t))return;e.uniform3iv(this.addr,t),$s(n,t)}}function dc(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(e.uniform4i(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(Qs(n,t))return;e.uniform4iv(this.addr,t),$s(n,t)}}function fc(e,t){let n=this.cache;n[0]!==t&&(e.uniform1ui(this.addr,t),n[0]=t)}function pc(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(e.uniform2ui(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(Qs(n,t))return;e.uniform2uiv(this.addr,t),$s(n,t)}}function mc(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(e.uniform3ui(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else{if(Qs(n,t))return;e.uniform3uiv(this.addr,t),$s(n,t)}}function hc(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(e.uniform4ui(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(Qs(n,t))return;e.uniform4uiv(this.addr,t),$s(n,t)}}function gc(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i);let a;this.type===e.SAMPLER_2D_SHADOW?(Hs.compareFunction=n.isReversedDepthBuffer()?518:515,a=Hs):a=Vs,n.setTexture2D(t||a,i)}function _c(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i),n.setTexture3D(t||Ws,i)}function vc(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i),n.setTextureCube(t||Gs,i)}function yc(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i),n.setTexture2DArray(t||Us,i)}function bc(e){switch(e){case 5126:return tc;case 35664:return nc;case 35665:return rc;case 35666:return ic;case 35674:return ac;case 35675:return oc;case 35676:return sc;case 5124:case 35670:return cc;case 35667:case 35671:return lc;case 35668:case 35672:return uc;case 35669:case 35673:return dc;case 5125:return fc;case 36294:return pc;case 36295:return mc;case 36296:return hc;case 35678:case 36198:case 36298:case 36306:case 35682:return gc;case 35679:case 36299:case 36307:return _c;case 35680:case 36300:case 36308:case 36293:return vc;case 36289:case 36303:case 36311:case 36292:return yc}}function xc(e,t){e.uniform1fv(this.addr,t)}function Sc(e,t){let n=Zs(t,this.size,2);e.uniform2fv(this.addr,n)}function Cc(e,t){let n=Zs(t,this.size,3);e.uniform3fv(this.addr,n)}function wc(e,t){let n=Zs(t,this.size,4);e.uniform4fv(this.addr,n)}function Tc(e,t){let n=Zs(t,this.size,4);e.uniformMatrix2fv(this.addr,!1,n)}function Ec(e,t){let n=Zs(t,this.size,9);e.uniformMatrix3fv(this.addr,!1,n)}function Dc(e,t){let n=Zs(t,this.size,16);e.uniformMatrix4fv(this.addr,!1,n)}function Oc(e,t){e.uniform1iv(this.addr,t)}function kc(e,t){e.uniform2iv(this.addr,t)}function Ac(e,t){e.uniform3iv(this.addr,t)}function jc(e,t){e.uniform4iv(this.addr,t)}function Mc(e,t){e.uniform1uiv(this.addr,t)}function Nc(e,t){e.uniform2uiv(this.addr,t)}function Pc(e,t){e.uniform3uiv(this.addr,t)}function Fc(e,t){e.uniform4uiv(this.addr,t)}function Ic(e,t,n){let r=this.cache,i=t.length,a=ec(n,i);Qs(r,a)||(e.uniform1iv(this.addr,a),$s(r,a));let o;o=this.type===e.SAMPLER_2D_SHADOW?Hs:Vs;for(let e=0;e!==i;++e)n.setTexture2D(t[e]||o,a[e])}function Lc(e,t,n){let r=this.cache,i=t.length,a=ec(n,i);Qs(r,a)||(e.uniform1iv(this.addr,a),$s(r,a));for(let e=0;e!==i;++e)n.setTexture3D(t[e]||Ws,a[e])}function Rc(e,t,n){let r=this.cache,i=t.length,a=ec(n,i);Qs(r,a)||(e.uniform1iv(this.addr,a),$s(r,a));for(let e=0;e!==i;++e)n.setTextureCube(t[e]||Gs,a[e])}function zc(e,t,n){let r=this.cache,i=t.length,a=ec(n,i);Qs(r,a)||(e.uniform1iv(this.addr,a),$s(r,a));for(let e=0;e!==i;++e)n.setTexture2DArray(t[e]||Us,a[e])}function Bc(e){switch(e){case 5126:return xc;case 35664:return Sc;case 35665:return Cc;case 35666:return wc;case 35674:return Tc;case 35675:return Ec;case 35676:return Dc;case 5124:case 35670:return Oc;case 35667:case 35671:return kc;case 35668:case 35672:return Ac;case 35669:case 35673:return jc;case 5125:return Mc;case 36294:return Nc;case 36295:return Pc;case 36296:return Fc;case 35678:case 36198:case 36298:case 36306:case 35682:return Ic;case 35679:case 36299:case 36307:return Lc;case 35680:case 36300:case 36308:case 36293:return Rc;case 36289:case 36303:case 36311:case 36292:return zc}}var Vc=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=bc(t.type)}},Hc=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Bc(t.type)}},Uc=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){let r=this.seq;for(let i=0,a=r.length;i!==a;++i){let a=r[i];a.setValue(e,t[a.id],n)}}},Wc=/(\w+)(\])?(\[|\.)?/g;function Gc(e,t){e.seq.push(t),e.map[t.id]=t}function Kc(e,t,n){let r=e.name,i=r.length;for(Wc.lastIndex=0;;){let a=Wc.exec(r),o=Wc.lastIndex,s=a[1],c=a[2]===`]`,l=a[3];if(c&&(s|=0),l===void 0||l===`[`&&o+2===i){Gc(n,l===void 0?new Vc(s,e,t):new Hc(s,e,t));break}{let e=n.map[s];e===void 0&&(e=new Uc(s),Gc(n,e)),n=e}}}var qc=class{constructor(e,t){this.seq=[],this.map={};let n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){let n=e.getActiveUniform(t,r);Kc(n,e.getUniformLocation(t,n.name),this)}let r=[],i=[];for(let t of this.seq)t.type===e.SAMPLER_2D_SHADOW||t.type===e.SAMPLER_CUBE_SHADOW||t.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(t):i.push(t);r.length>0&&(this.seq=r.concat(i))}setValue(e,t,n,r){let i=this.map[t];i!==void 0&&i.setValue(e,n,r)}setOptional(e,t,n){let r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let i=0,a=t.length;i!==a;++i){let a=t[i],o=n[a.id];o.needsUpdate!==!1&&a.setValue(e,o.value,r)}}static seqWithValue(e,t){let n=[];for(let r=0,i=e.length;r!==i;++r){let i=e[r];i.id in t&&n.push(i)}return n}};function Jc(e,t,n){let r=e.createShader(t);return e.shaderSource(r,n),e.compileShader(r),r}var Yc=37297,Xc=0;function Zc(e,t){let n=e.split(`
`),r=[],i=Math.max(t-6,0),a=Math.min(t+6,n.length);for(let e=i;e<a;e++){let i=e+1;r.push(`${i===t?`>`:` `} ${i}: ${n[e]}`)}return r.join(`
`)}var Qc=new q;function $c(e){J._getMatrix(Qc,J.workingColorSpace,e);let t=`mat3( ${Qc.elements.map(e=>e.toFixed(4))} )`;switch(J.getTransfer(e)){case Re:return[t,`LinearTransferOETF`];case ze:return[t,`sRGBTransferOETF`];default:return H(`WebGLProgram: Unsupported color space: `,e),[t,`LinearTransferOETF`]}}function el(e,t,n){let r=e.getShaderParameter(t,e.COMPILE_STATUS),i=(e.getShaderInfoLog(t)||``).trim();if(r&&i===``)return``;let a=/ERROR: 0:(\d+)/.exec(i);if(a){let r=parseInt(a[1]);return n.toUpperCase()+`

`+i+`

`+Zc(e.getShaderSource(t),r)}return i}function tl(e,t){let n=$c(t);return[`vec4 ${e}( vec4 value ) {`,`	return ${n[1]}( vec4( value.rgb * ${n[0]}, value.a ) );`,`}`].join(`
`)}var nl={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function rl(e,t){let n=nl[t];return n===void 0?(H(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var il=new K;function al(){return J.getLuminanceCoefficients(il),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${il.x.toFixed(4)}, ${il.y.toFixed(4)}, ${il.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Jc(i,i.VERTEX_SHADER,y),S=Jc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=el(i,x,`vertex`),n=el(i,S,`fragment`);U(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
    ...
    `+t.fragmentShader,t.fragmentShader=t.fragmentShader.replace(`#include <dithering_fragment>`,`
      ...
      #endif
      `)}}function Bu(){let e=document.createElement(`canvas`);e.width=128,e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(85,45,8,64,64,75);n.addColorStop(0,`#ff4d6d`),n.addColorStop(.3,`#e11d48`),n.addColorStop(.7,`#be123c`),n.addColorStop(1,`#881337`),t.fillStyle=n,t.fillRect(0,0,128,128),t.fillStyle=`rgba(255, 235, 180, 0.4)`;for(let e=0;e<40;e++){let e=Math.random()*128,n=Math.random()*128;t.fillRect(e,n,1.5,1.5)}return new ai(e)}function Vu(){let e=document.createElement(`canvas`);e.width=64,e.height=128;let t=e.getContext(`2d`),n=t.createLinearGradient(0,0,0,128);n.addColorStop(0,`#ff7a00`),n.addColorStop(.5,`#ff6b00`),n.addColorStop(1,`#ea580c`),t.fillStyle=n,t.fillRect(0,0,64,128),t.strokeStyle=`#c2410c`,t.lineWidth=2.2;for(let e=14;e<120;e+=16)t.beginPath(),t.moveTo(6+Math.random()*4,e),t.lineTo(54-Math.random()*4,e),t.stroke();return new ai(e)}function Hu(){let e=document.createElement(`canvas`);e.width=128,e.height=128;let t=e.getContext(`2d`);t.fillStyle=`#16a34a`,t.fillRect(0,0,128,128);for(let e=0;e<300;e++){let e=Math.random()*128,n=Math.random()*128,r=2+Math.random()*3.5;t.fillStyle=Math.random()>.5?`#14532d`:`#22c55e`,t.beginPath(),t.arc(e,n,r,0,Math.PI*2),t.fill()}return new ai(e)}function Uu(){let e=document.createElement(`canvas`);e.width=128,e.height=128;let t=e.getContext(`2d`);t.fillStyle=`#fef3c7`,t.fillRect(0,0,128,128),t.fillStyle=`#b45309`;for(let e=0;e<35;e++){let e=Math.random()*128,n=Math.random()*128,r=Math.random()*4+1.5;t.beginPath(),t.arc(e,n,r,0,Math.PI*2),t.fill()}t.fillStyle=`#78350f`;for(let e=0;e<15;e++){let e=Math.random()*128,n=Math.random()*128,r=Math.random()*2+1;t.beginPath(),t.arc(e,n,r,0,Math.PI*2),t.fill()}return new ai(e)}function Wu(){let e=document.createElement(`canvas`);e.width=64,e.height=64;let t=e.getContext(`2d`);t.fillStyle=`#fefce8`,t.fillRect(0,0,64,64),t.fillStyle=`rgba(217, 119, 6, 0.4)`,t.fillRect(0,10,64,10),t.fillRect(0,36,64,10),t.fillStyle=`#15803d`;for(let e=0;e<20;e++){let e=Math.random()*64,n=Math.random()*64;t.fillRect(e,n,2,2)}return new ai(e)}function Gu(){let e=document.createElement(`canvas`);e.width=128,e.height=128;let t=e.getContext(`2d`),n=t.createLinearGradient(0,0,128,0);n.addColorStop(0,`#0284c7`),n.addColorStop(.4,`#7dd3fc`),n.addColorStop(1,`#f0f9ff`),t.fillStyle=n,t.fillRect(0,0,128,128),t.fillStyle=`rgba(255,255,255,0.3)`;for(let e=10;e<120;e+=12)for(let n=10;n<120;n+=8)t.beginPath(),t.arc(e+(n%16==0?6:0),n,3,0,Math.PI),t.fill();t.fillStyle=`#ffffff`;for(let e=0;e<30;e++){let e=30+Math.random()*70,n=20+Math.random()*88;t.beginPath(),t.arc(e,n,1.5,0,Math.PI*2),t.fill()}return new ai(e)}function Ku(){let e=new Cn,t=new ja(.5,1),n=t.attributes.position,r=new K;for(let e=0;e<n.count;e++)r.fromBufferAttribute(n,e),r.y>.35&&(r.y-=.08*(r.y-.35)),r.y<-.35&&(r.y+=.08*(-.35-r.y)),n.setXYZ(e,r.x,r.y,r.z);t.computeVertexNormals();let i=new Ya({map:Bu(),roughness:.14,metalness:.04,clearcoat:1,clearcoatRoughness:.04});zu(i,`#e11d48`,.5);let a=new Z(t,i);a.scale.set(1,.88,1),e.add(a);let o=new di(.02,.03,.25,5);o.translate(0,.125,0);let s=new Ja({color:`#5c4033`,roughness:.8});zu(s,`#5c4033`,.25);let c=new Z(o,s);c.position.set(0,.3,0),c.rotation.z=-.2,c.rotation.x=.1,e.add(c);let l=new fi(.12,.25,5),u=new Ja({color:`#16a34a`,roughness:.6});zu(u,`#16a34a`,.3);let d=new Z(l,u);return d.scale.set(1,.2,2),d.position.set(.08,.38,.02),d.rotation.z=-.6,d.rotation.y=.5,e.add(d),e.name=`apple`,e}function qu(){let e=new Cn,t=new Ma([new G(0,.7),new G(.18,.6),new G(.19,.4),new G(.15,0),new G(.09,-.4),new G(.02,-.75),new G(0,-.8)],8),n=new Ja({map:Vu(),roughness:.5,metalness:.05});zu(n,`#ff6b00`,.5);let r=new Z(t,n);e.add(r);let i=new Cn,a=new di(.015,.02,.35,5);a.translate(0,.175,0);let o=new Ja({color:`#16a34a`,roughness:.7});zu(o,`#16a34a`,.35);for(let e=0;e<3;e++){let t=new Z(a,o);t.rotation.z=.3*Math.sin(e*(Math.PI*2/3)),t.rotation.x=.3*Math.cos(e*(Math.PI*2/3));let n=new Z(new fi(.07,.18,4),o);n.position.y=.35,n.scale.set(1.5,.3,2.5),t.add(n),i.add(t)}return i.position.y=.65,e.add(i),e.name=`carrot`,e}function Ju(){let e=new Cn,t=new La(new Ci([new K(-.4,.35,0),new K(-.25,.05,.05),new K(0,-.15,.08),new K(.28,-.05,.05),new K(.45,.28,0)]),10,.11,5,!1),n=document.createElement(`canvas`);n.width=128,n.height=32;let r=n.getContext(`2d`);r.fillStyle=`#ffd60a`,r.fillRect(0,0,128,32),r.fillStyle=`#4a2f0f`,r.fillRect(0,0,8,32),r.fillRect(122,0,6,32),r.fillStyle=`#65a30d`,r.fillRect(8,0,8,32),r.fillRect(116,0,6,32);let i=new Ja({map:new ai(n),roughness:.35,metalness:.05});zu(i,`#ffd60a`,.45);let a=new Z(t,i);return e.add(a),e.name=`banana`,e}function Yu(){let e=new Cn,t=new Ma([new G(0,.3),new G(.1,.3),new G(.08,-.1),new G(.14,-.4),new G(0,-.4)],6),n=new Ja({color:`#22c55e`,roughness:.65});zu(n,`#22c55e`,.3);let r=new Z(t,n);e.add(r);let i=new Cn,a=new ja(.3,1),o=new Ja({map:Hu(),roughness:.85,metalness:0});return zu(o,`#16a34a`,.5),[{x:0,y:.4,z:0,s:1.15},{x:.16,y:.32,z:.12,s:.85},{x:-.16,y:.35,z:-.1,s:.9},{x:.08,y:.28,z:-.18,s:.8},{x:-.08,y:.3,z:.18,s:.85}].forEach(e=>{let t=new Z(a,o);t.position.set(e.x,e.y,e.z),t.scale.set(e.s,e.s*.8,e.s),t.rotation.set(Math.random()*5,Math.random()*5,0),i.add(t)}),e.add(i),e.name=`greens`,e}function Xu(){let e=new Cn,t=new di(.48,.48,.04,16),n=new Ja({map:Uu(),roughness:.75,metalness:.05});zu(n,`#d97706`,.45);let r=new Z(t,n);r.position.set(0,-.05,0),r.rotation.y=.2,e.add(r);let i=new Z(t,n);return i.position.set(.04,.01,.02),i.rotation.y=-.5,i.rotation.x=.05,e.add(i),e.name=`roti`,e}function Zu(){let e=new Cn,t=new Fa(.38,14,14,0,Math.PI*2,0,Math.PI*.5);t.scale(.85,1.25,.85);let n=new Ya({color:`#f8fafc`,roughness:.15,metalness:.05,clearcoat:.9,clearcoatRoughness:.05});zu(n,`#f59e0b`,.4);let r=new Z(t,n);r.rotation.x=Math.PI,e.add(r);let i=new ui(.38,14);i.scale(.85,.85,1);let a=new Z(i,new Ja({color:`#f1f5f9`,roughness:.2}));a.rotation.x=-Math.PI/2,e.add(a);let o=new Fa(.18,12,12,0,Math.PI*2,0,Math.PI*.5),s=new Ja({color:`#fbbf24`,roughness:.35,metalness:.05});zu(s,`#f59e0b`,.45);let c=new Z(o,s);return c.position.set(0,.01,-.05),e.add(c),e.rotation.x=.3,e.name=`egg`,e}function Qu(){let e=new Cn,t=new Ja({map:Wu(),roughness:.5,metalness:.05});zu(t,`#fbbf24`,.45);let n=new li(.28,.28,.28);return[{x:-.15,y:-.05,z:.1,ry:.1},{x:.16,y:-.05,z:-.1,ry:.4},{x:-.08,y:-.05,z:-.18,ry:-.2},{x:.02,y:.2,z:0,ry:.6}].forEach(r=>{let i=new Z(n,t);i.position.set(r.x,r.y,r.z),i.rotation.y=r.ry,e.add(i)}),e.name=`paneer`,e}function $u(){let e=new Cn,t=new Ma([new G(0,.65),new G(.12,.55),new G(.22,.35),new G(.25,0),new G(.18,-.3),new G(.06,-.55),new G(.02,-.65),new G(0,-.68)],8),n=new Ya({map:Gu(),roughness:.16,metalness:.6,clearcoat:.8,clearcoatRoughness:.08});zu(n,`#0284c7`,.45);let r=new Z(t,n);r.scale.set(.48,1.1,1.25),r.rotation.x=Math.PI/2,e.add(r);let i=new Wi;i.moveTo(0,0),i.lineTo(.2,.25),i.quadraticCurveTo(.25,.1,.15,0),i.quadraticCurveTo(.25,-.1,.2,-.25),i.lineTo(0,0);let a=new Oa(i,{depth:.03,bevelEnabled:!1}),o=new Ja({color:`#0284c7`,roughness:.5});zu(o,`#0284c7`,.35);let s=new Z(a,o);s.position.set(0,0,-.85),s.rotation.y=Math.PI/2,e.add(s);let c=new Fa(.045,5,5),l=new Ja({color:`#ffffff`,roughness:.1}),u=new Ja({color:`#000000`,roughness:.1}),d=new Z(c,l),f=new Z(new Fa(.02,5,5),u);f.position.set(0,0,.035),d.add(f),d.position.set(.12,.08,.42),e.add(d);let p=new Z(c,l),m=new Z(new Fa(.02,5,5),u);return m.position.set(0,0,.035),p.add(m),p.position.set(-.12,.08,.42),e.add(p),e.name=`fish`,e}function ed(){let e=new Cn,t=new Ma([new G(0,-.3),new G(.25,-.3),new G(.42,-.05),new G(.46,.15),new G(.42,.18),new G(.38,.15),new G(0,.12)],12),n=new Ja({color:`#9a3412`,roughness:.75});zu(n,`#ea580c`,.35);let r=new Z(t,n);e.add(r);let i=new di(.38,.34,.05,16),a=new Ya({color:`#f8fafc`,roughness:.18,metalness:.02,clearcoat:.6,clearcoatRoughness:.08});zu(a,`#06b6d4`,.4);let o=new Z(i,a);o.position.y=.11,e.add(o);let s=new Z(new fi(.06,.14,4),new Ja({color:`#16a34a`,roughness:.6}));return s.position.set(0,.14,0),s.rotation.z=.6,s.scale.set(1.2,.3,2),e.add(s),e.name=`curd`,e}function td(){let e=new Cn,t=new Z(new di(1.6,1.4,.1,24),new Ja({color:`#ffffff`,roughness:.3,metalness:.05}));t.receiveShadow=!0,e.add(t);let n=new Z(new Ia(1.6,.08,6,32),new Ja({color:`#f1f5f9`,roughness:.35}));n.rotation.x=Math.PI/2,n.position.y=.05,e.add(n);let r=(t,n,r,i)=>{let a=new Z(new Pa(0,i,24,1,n,r-n),new Ja({color:t,side:2,roughness:.45}));a.rotation.x=Math.PI/2,a.position.y=.06,e.add(a)},i=1.48;r(`#22c55e`,0,Math.PI*.65,i),r(`#e11d48`,Math.PI*.65,Math.PI,i),r(`#f97316`,Math.PI,Math.PI*1.5,i),r(`#6366f1`,Math.PI*1.5,Math.PI*2,i);let a=new Z(new di(.38,.34,.08,16),new Ja({color:`#06b6d4`,roughness:.35}));a.position.set(1.4,.08,-1),e.add(a);let o=new Z(new Ia(.38,.02,4,20),new Ja({color:`#ffffff`,roughness:.3}));return o.rotation.x=Math.PI/2,o.position.set(1.4,.12,-1),e.add(o),e.name=`plate`,e}function nd(e){switch(e){case`apple`:return Ku();case`carrot`:return qu();case`banana`:return Ju();case`greens`:return Yu();case`roti`:return Xu();case`egg`:return Zu();case`paneer`:return Qu();case`fish`:return $u();case`curd`:return ed();default:return console.warn(`Unknown model ID: ${e}`),new Cn}}var rd={apple:{id:`apple`,name:`Red Apple`,group:`fruit`,plateSection:`50% Fruits & Vegetables`,color:`#e11d48`,tagline:`Rich in pectin fiber and Vitamin C for immunity!`,nutrients:{calories:95,carbs:`25g`,fiber:`4.4g`,vitamins:`Vitamin C, Potassium`,protein:`0.5g`,fat:`0.3g`,sugar:`19g`,sodium:`2mg`},funFacts:[`Apples are 25% air, which is why they float in water!`,`Eating whole apples with the peel provides soluble pectin fiber, keeping your digestion smooth.`,`Apples have a low glycemic index, giving steady energy without blood sugar spikes.`]},banana:{id:`banana`,name:`Banana`,group:`fruit`,plateSection:`50% Fruits & Vegetables`,color:`#ffd60a`,tagline:`Powerhouse of potassium and instant natural energy!`,nutrients:{calories:105,carbs:`27g`,fiber:`3g`,vitamins:`Vitamin B6, Vitamin C, Potassium`,protein:`1.3g`,fat:`0.3g`,sugar:`14g`,sodium:`1mg`},funFacts:[`Bananas are prized for high prebiotic fiber and essential minerals!`,`Potassium in bananas helps regulate blood pressure, prevents muscle cramps, and supports heart rhythm.`,`Bananas contain Vitamin B6, which helps your body produce serotonin for better focus and mood.`]},carrot:{id:`carrot`,name:`Orange Carrot`,group:`vegetable`,plateSection:`50% Fruits & Vegetables`,color:`#ff6b00`,tagline:`Supercharged with Beta-Carotene & Vitamin A for sharp eyesight!`,nutrients:{calories:41,carbs:`10g`,fiber:`2.8g`,vitamins:`Vitamin A (Beta-carotene), Vitamin K1`,protein:`0.9g`,fat:`0.2g`,sugar:`4.7g`,sodium:`69mg`},funFacts:[`The vivid orange color comes from Beta-carotene, which your liver converts into Vitamin A.`,`Vitamin A is critical for protecting the cornea and enabling vision in low light/night conditions.`,`Eating carrots with a little healthy fat (like in dal or curry) boosts Vitamin A absorption by 300%!`]},greens:{id:`greens`,name:`Palak / Leafy Greens`,group:`vegetable`,plateSection:`50% Fruits & Vegetables`,color:`#16a34a`,tagline:`Iron and folate champion for healthy blood and stamina!`,nutrients:{calories:23,carbs:`3.6g`,fiber:`2.2g`,vitamins:`Iron, Folate, Vitamin K, Vitamin C`,protein:`2.9g`,fat:`0.4g`,sugar:`0.4g`,sodium:`79mg`},funFacts:[`Dark green leafy vegetables like Palak, Cheera, and Moringa are rich in non-heme iron and folate.`,`Vitamin K in greens plays a major role in bone density and natural blood clotting.`,`Combining greens with Vitamin C (like a squeeze of lemon or tomato) helps your body absorb the iron much faster.`]},roti:{id:`roti`,name:`Whole Wheat Roti / Chapati`,group:`grain`,plateSection:`25% Carbohydrates`,color:`#d97706`,tagline:`Complex carbohydrates for sustained energy and focus!`,nutrients:{calories:120,carbs:`22g`,fiber:`3.5g`,vitamins:`B Vitamins, Iron, Magnesium`,protein:`3.8g`,fat:`1.5g`,sugar:`0.5g`,sodium:`110mg`},funFacts:[`Whole wheat retains the bran, germ, and endosperm, packing 3x more fiber than refined white flour.`,`Complex carbohydrates break down slowly into glucose, providing steady fuel for school and sports.`,`Whole grain rotis are rich in magnesium, which helps convert the food you eat into cellular energy.`]},egg:{id:`egg`,name:`Boiled Egg`,group:`protein`,plateSection:`25% Protein`,color:`#f59e0b`,tagline:`Gold standard complete protein for muscle building & memory!`,nutrients:{calories:78,carbs:`0.6g`,fiber:`0g`,vitamins:`Choline, Vitamin B12, Vitamin D, Zinc`,protein:`6.3g`,fat:`5.3g`,sugar:`0.6g`,sodium:`62mg`},funFacts:[`Eggs contain all 9 essential amino acids in the exact proportions needed by growing teenagers!`,`The yolk is rich in Choline, a vital nutrient that powers neurotransmitters in the brain for memory and learning.`,`Egg protein has a biological value of 100, meaning almost all of it is usable by your body to repair tissue.`]},paneer:{id:`paneer`,name:`Fresh Paneer / Dal`,group:`protein`,plateSection:`25% Protein`,color:`#fbbf24`,tagline:`Vegetarian protein and calcium powerhouse for strong bones!`,nutrients:{calories:130,carbs:`2.5g`,fiber:`0g`,vitamins:`Calcium, Phosphorus, Vitamin B12`,protein:`9.0g`,fat:`9.5g`,sugar:`1.2g`,sodium:`85mg`},funFacts:[`Paneer and lentils (Dal) are staple vegetarian protein sources across Indian cuisine.`,`Paneer is rich in Calcium and Phosphorus, which work together to harden bone matrix and enamel.`,`Combining lentils (Dal) with grains (Rice or Roti) creates a complete protein profile with all essential amino acids!`]},fish:{id:`fish`,name:`Fish`,group:`protein`,plateSection:`25% Protein`,color:`#0284c7`,tagline:`Lean protein packed with brain-boosting Omega-3s!`,nutrients:{calories:140,carbs:`0g`,fiber:`0g`,vitamins:`Omega-3 Fatty Acids, Vitamin D, Selenium`,protein:`20g`,fat:`6.0g`,sugar:`0g`,sodium:`70mg`},funFacts:[`Fish like Sardines, Mackerel, and Salmon are loaded with natural Omega-3 fatty acids.`,`Omega-3s form the structural lipids of brain cell membranes, enhancing concentration and cognitive speed.`,`Fish is naturally low in saturated fats and provides bioavailable Vitamin D for bone and immune health.`]},curd:{id:`curd`,name:`Curd / Sambharam (Buttermilk)`,group:`dairy`,plateSection:`Accompaniment`,color:`#06b6d4`,tagline:`Cooling probiotic for gut health, digestion, and calcium!`,nutrients:{calories:60,carbs:`4.5g`,fiber:`0g`,vitamins:`Probiotics (Lactobacillus), Calcium, Vitamin B2`,protein:`4.0g`,fat:`2.5g`,sugar:`4.0g`,sodium:`55mg`},funFacts:[`Traditional spiced buttermilk (Sambharam with ginger, curry leaves, and green chili) is Kerala’s natural hydrator.`,`Curd is packed with live probiotic bacteria (Lactobacillus) that strengthen gut microbiome and digestion.`,`Fermentation in curd breaks down lactose, making it easier to digest while delivering rich calcium.`]}},id=[{id:1,question:`According to the 50–25–25 Healthy Plate model, what portion of your plate should consist of colorful vegetables and fruits?`,options:[`One quarter (25%)`,`One half (50%)`,`Three quarters (75%)`,`Only 10%`],answer:1,explanation:`The 50–25–25 model recommends filling exactly half (50%) of your plate with vegetables and fruits to ensure adequate intake of dietary fiber, vitamins, and minerals.`},{id:2,question:`In the 50–25–25 plate framework, what should make up the two remaining 25% quarters of your meal?`,options:[`25% Sweets and 25% Fried snacks`,`25% Complex Carbohydrates (like Roti/Matta Rice) and 25% Healthy Proteins (like Dal/Egg/Fish)`,`50% Extra Rice and no protein`,`25% Soda and 25% Fast food`],answer:1,explanation:`The remaining plate is divided evenly: 25% for complex carbohydrates (whole grains for steady energy) and 25% for protein (for muscle repair and growth).`},{id:3,question:`Why is traditional Kerala red Matta rice or whole wheat Roti healthier than polished white rice?`,options:[`They contain more sugar`,`They retain the outer bran layer rich in fiber, minerals, and B-vitamins, giving slow, steady energy`,`They digest in under 5 minutes`,`They have zero carbohydrates`],answer:1,explanation:`Whole grains retain their bran and germ layers, providing high dietary fiber and B-vitamins that prevent sudden blood sugar spikes and keep energy steady.`},{id:4,question:`Which nutrient, abundant in orange carrots and mangoes, is essential for maintaining sharp vision in low light?`,options:[`Vitamin C`,`Beta-carotene (provitamin A)`,`Vitamin D`,`Sodium`],answer:1,explanation:`Beta-carotene in orange vegetables is converted by your body into Vitamin A, which protects the cornea and supports night vision.`},{id:5,question:`Why is pairing Dal (lentils) with Rice or Roti considered a smart nutritional strategy in Indian meals?`,options:[`It makes the food sweeter`,`Grains and lentils have complementary amino acids that together form a complete protein`,`It removes all fats from the plate`,`It replaces the need to drink water`],answer:1,explanation:`Cereals lack lysine while pulses lack methionine; combining them (like Dal-Roti or Dal-Chawal) provides all 9 essential amino acids for complete protein absorption.`},{id:6,question:`Which healthy fat found in fish like Sardines and Mackerel is critical for brain function and memory?`,options:[`Trans fat`,`Saturated animal fat`,`Omega-3 fatty acids`,`Palm oil`],answer:2,explanation:`Omega-3 fatty acids are essential unsaturated fats that build brain and nerve cell membranes, boosting concentration and memory.`},{id:7,question:`What makes traditional Curd and spiced Buttermilk (Sambharam) beneficial for teenage digestion?`,options:[`They contain high refined sugar`,`They provide live probiotic bacteria (Lactobacillus) and bioavailable calcium for gut and bone health`,`They replace vegetables on the plate`,`They are artificial soft drinks`],answer:1,explanation:`Fermented dairy provides probiotics that support a healthy gut microbiome, smooth digestion, and strong bones through bioavailable calcium.`},{id:8,question:`Dark leafy greens like Palak, Cheera, and Moringa (drumstick leaves) are rich in which vital mineral that transports oxygen in your blood?`,options:[`Iron`,`Sodium`,`Potassium`,`Chlorine`],answer:0,explanation:`Green leafy vegetables are packed with iron, which is the core component of hemoglobin needed to carry oxygen to your muscles and brain.`},{id:9,question:`What is the healthiest choice for daily hydration during school and sports activities?`,options:[`Packaged energy drinks`,`Carbonated sugary sodas`,`Plain water, tender coconut water, or fresh buttermilk`,`Commercial fruit syrup drinks`],answer:2,explanation:`Plain water, tender coconut, and buttermilk hydrate naturally without added sugars, chemical preservatives, or caffeine crashes.`},{id:10,question:`If a snack has 20 grams of added sugar per serving, approximately how many teaspoons of sugar is that?`,options:[`1 teaspoon`,`2.5 teaspoons`,`5 teaspoons`,`10 teaspoons`],answer:2,explanation:`Every 4 grams of sugar equals approximately 1 teaspoon. 20 grams of added sugar is equal to 5 full teaspoons of sugar in a single serving!`},{id:11,question:`Which nutrient is the primary building block for growing muscles, repairing tissues, and making hormones during teenage growth?`,options:[`Protein`,`Saturated fat`,`Added sugar`,`Cholesterol`],answer:0,explanation:`Proteins (found in eggs, paneer, fish, dal, and nuts) break down into amino acids that physically build and repair muscles, organs, and skin.`},{id:12,question:`Why should we be mindful of consuming too many packaged fried snacks and deep-fried fast foods?`,options:[`They contain too much natural fiber`,`They are high in unhealthy saturated/trans fats and sodium, which can strain heart health and cause fatigue`,`They have too much Vitamin C`,`They cause too much bone growth`],answer:1,explanation:`Deep-fried foods and ultra-processed snacks are high in oxidized fats and sodium, causing energy crashes and increasing cardiovascular risk.`}];function ad(e){if(e.length===0)return{score:0,grade:`Empty Plate`,summary:`Your plate is currently empty! Add foods from the shelves to build a balanced 50–25–25 meal.`,color:`#94a3b8`,tips:[`Click items on the shelves to add vegetables, grains, and proteins to your plate.`],breakdown:{vegFruit:0,carbs:0,protein:0,dairy:0},nutrients:{calories:0,carbs:`0g`,fiber:`0g`,protein:`0g`,fat:`0g`,sugar:`0g`,sodium:`0mg`}};let t=0,n=0,r=0,i=0,a=0,o=0,s=0,c=0,l=0,u=0,d=0;e.forEach(e=>{let f=rd[e];f&&(f.group===`fruit`||f.group===`vegetable`?t++:f.group===`grain`?n++:f.group===`protein`?r++:f.group===`dairy`&&i++,a+=f.nutrients.calories,o+=parseFloat(f.nutrients.sugar),s+=parseFloat(f.nutrients.sodium),c+=parseFloat(f.nutrients.protein),l+=parseFloat(f.nutrients.carbs),u+=parseFloat(f.nutrients.fat),d+=parseFloat(f.nutrients.fiber||`0`))});let f=e.length,p=50,m=[];t>=2?p+=25:t===1?(p+=12,m.push(`🌱 Add another vegetable or fruit! The 50–25–25 model recommends filling half your plate with colorful produce.`)):(p-=20,m.push(`⚠️ Missing 50% Produce: Your plate needs vegetables and fruits for fiber, vitamins, and cellular protection.`)),n===1?p+=15:n===0?m.push(`🫓 Add a whole grain (like Whole Wheat Roti) to fulfill the 25% complex carbohydrate portion for stamina.`):n>1&&(p-=10,m.push(`Grain Portion Alert: Too many carbohydrates on the plate. Stick to 1 grain serving (25% of plate) to keep blood sugar stable.`)),r>=1&&r<=2?p+=15:r===0?(p-=15,m.push(`🍳 Missing 25% Protein: Add Paneer, Egg, Dal, or Fish to provide amino acids for muscle growth and repair.`)):r>2&&(p-=5,m.push(`Excess Protein: One to two quality protein sources are plenty for a single meal.`)),i>=1&&(p+=5),f>5&&(p-=(f-5)*5,m.push(`Large Portion: Try building a focused meal with 3–4 items to maintain optimal energy without sluggishness.`)),p=Math.max(10,Math.min(100,p));let h=`Needs Adjustment`,g=``,_=`#ef4444`;return p>=90?(h=`Ideal 50–25–25 Balance! 🌟`,g=`Outstanding! Your plate aligns with the 50–25–25 Healthy Plate model (50% Vegetables & Fruits, 25% Whole Grains, 25% Protein).`,_=`#22c55e`):p>=75?(h=`Very Good Meal! 👍`,g=`Great job! This is a nutritious meal with good variety. A few small tweaks will make it a textbook 50–25–25 plate.`,_=`#10b981`):p>=60?(h=`Fair Start 🥗`,g=`You have good components, but the plate proportions need adjustment to match the 50% produce and 25% protein targets.`,_=`#f59e0b`):(h=`Unbalanced Plate ⚠️`,g=`This meal is missing key food groups or has unbalanced proportions. Follow the 50–25–25 guidelines below!`,_=`#ef4444`),m.length===0&&m.push(`Your meal has a 50–25–25 balance! Try switching up different vegetables and proteins across days.`),{score:p,grade:h,summary:g,color:_,tips:m,breakdown:{vegFruit:t,carbs:n,protein:r,dairy:i},nutrients:{calories:Math.round(a),carbs:Math.round(l)+`g`,fiber:d.toFixed(1)+`g`,protein:Math.round(c)+`g`,fat:Math.round(u)+`g`,sugar:Math.round(o)+`g`,sodium:Math.round(s)+`mg`}}}var od=new class{constructor(){this.container=null,this.scene=null,this.camera=null,this.renderer=null,this.controls=null,this.plate=null,this.foods={},this.shelves=[],this.groundPlatform=null,this.foodGlowPads={},this.raycaster=new qo,this.mouse=new G,this.hoveredFoodId=null,this.currentView=`landing`,this.targetCameraPos=new K(0,5,8),this.targetCameraLookAt=new K(0,0,0),this.lastTime=performance.now()*.001,this.startTime=this.lastTime,this.foodAnimations={},this.onHoverCallback=null,this.onClickCallback=null,this.selectedFoodIds=[]}init(e){this.container=e,this.scene=new jn,this.scene.background=null,this.camera=new To(45,this.container.clientWidth/this.container.clientHeight,.1,100),this.camera.position.copy(this.targetCameraPos),this.renderer=new hu({antialias:!0,alpha:!0}),this.renderer.setSize(this.container.clientWidth,this.container.clientHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=1,this.container.appendChild(this.renderer.domElement),this.controls=new Eu(this.camera,this.renderer.domElement),this.controls.enableDamping=!0,this.controls.dampingFactor=.05,this.controls.minDistance=3,this.controls.maxDistance=15,this.controls.maxPolarAngle=Math.PI/2-.05,this.controls.target.copy(this.targetCameraLookAt);let t=new ko(`#ffffff`,.55);this.scene.add(t);let n=new Oo(`#ffffff`,1.25);n.position.set(6,12,5),n.castShadow=!0,n.shadow.mapSize.width=1024,n.shadow.mapSize.height=1024,n.shadow.bias=-5e-4,this.scene.add(n);let r=new Oo(`#e0e7ff`,.65);r.position.set(-6,8,-3),this.scene.add(r);let i=new Oo(`#fed7aa`,.45);i.position.set(0,-8,6),this.scene.add(i),this.createGroundPlatform(),this.plate=td(),this.plate.position.set(0,-.4,0),this.scene.add(this.plate),Object.keys(rd).forEach(e=>{let t=nd(e);t.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)}),this.scene.add(t),this.foods[e]=t,this.foodAnimations[e]={currentPos:new K,currentTargetPos:new K,currentRot:new K,currentTargetRot:new K,currentScale:new K(1,1,1),currentTargetScale:new K(1,1,1),scaleVelocity:new K(0,0,0),bobSpeed:1.2+Math.random()*.4,bobOffset:Math.random()*Math.PI*2,rotSpeed:.2+Math.random()*.2},this.createFoodGlowPad(e)}),this.createShelves(),window.addEventListener(`resize`,this.onWindowResize.bind(this)),this.container.addEventListener(`mousemove`,this.onMouseMove.bind(this)),this.container.addEventListener(`click`,this.onMouseClick.bind(this)),this.setView(`landing`),this.tick()}createGroundPlatform(){let e=document.createElement(`canvas`);e.width=256,e.height=256;let t=e.getContext(`2d`),n=t.createRadialGradient(128,128,10,128,128,120);n.addColorStop(0,`rgba(99, 102, 241, 0.25)`),n.addColorStop(.5,`rgba(99, 102, 241, 0.08)`),n.addColorStop(.8,`rgba(6, 182, 212, 0.03)`),n.addColorStop(1,`rgba(0, 0, 0, 0)`),t.fillStyle=n,t.fillRect(0,0,256,256),t.strokeStyle=`rgba(99, 102, 241, 0.25)`,t.lineWidth=3,t.setLineDash([6,8]),t.beginPath(),t.arc(128,128,90,0,Math.PI*2),t.stroke(),t.strokeStyle=`rgba(6, 182, 212, 0.15)`,t.lineWidth=2,t.setLineDash([4,6]),t.beginPath(),t.arc(128,128,60,0,Math.PI*2),t.stroke();let r=new ai(e),i=new Na(6.5,6.5),a=new Fr({map:r,transparent:!0,depthWrite:!1,side:2});this.groundPlatform=new Z(i,a),this.groundPlatform.rotation.x=-Math.PI/2,this.groundPlatform.position.y=-.46,this.scene.add(this.groundPlatform)}createFoodGlowPad(e){let t=rd[e].color,n=document.createElement(`canvas`);n.width=64,n.height=64;let r=n.getContext(`2d`),i=r.createRadialGradient(32,32,2,32,32,30);i.addColorStop(0,t+`aa`),i.addColorStop(.4,t+`33`),i.addColorStop(1,t+`00`),r.fillStyle=i,r.fillRect(0,0,64,64);let a=new ai(n),o=new Z(new Na(.85,.85),new Fr({map:a,transparent:!0,depthWrite:!1,side:2,blending:2}));o.rotation.x=-Math.PI/2,o.position.y=-.38,this.scene.add(o),this.foodGlowPads[e]=o}createShelves(){let e=new Ja({color:`#85583f`,roughness:.9,metalness:.1}),t=new li(3.6,.1,.9),n=new Z(t,e);n.position.set(-3.5,-.45,-1),n.receiveShadow=!0,this.scene.add(n),this.shelves.push(n);let r=new Z(t,e);r.position.set(3.5,-.45,-1),r.receiveShadow=!0,this.scene.add(r),this.shelves.push(r),this.shelves.forEach(e=>e.visible=!1)}setView(e){this.currentView=e;let t=Object.keys(this.foods);e===`landing`?(this.plate.visible=!0,this.groundPlatform.visible=!0,this.plate.position.set(0,-.4,0),this.shelves.forEach(e=>e.visible=!1),this.controls.autoRotate=!0,this.controls.autoRotateSpeed=.65,t.forEach((e,n)=>{this.foods[e].visible=!0,this.foodGlowPads[e].visible=!0;let r=n/t.length*Math.PI*2,i=3.6,a=Math.sin(r)*i,o=Math.cos(r)*i,s=this.foodAnimations[e];s.currentTargetPos.set(a,.4,o),s.currentTargetRot.set(0,r,0),s.currentTargetScale.set(1,1,1),s.currentPos.length()===0&&(s.currentPos.copy(s.currentTargetPos),s.currentRot.copy(s.currentTargetRot),s.currentScale.copy(s.currentTargetScale),this.foods[e].position.copy(s.currentPos),this.foods[e].rotation.setFromVector3(s.currentRot),this.foods[e].scale.copy(s.currentScale))}),this.targetCameraPos.set(0,3.8,6.8),this.targetCameraLookAt.set(0,-.2,0)):e===`meal-builder`?(this.plate.visible=!0,this.groundPlatform.visible=!0,this.plate.position.set(0,-.45,0),this.shelves.forEach(e=>e.visible=!0),this.controls.autoRotate=!1,this.selectedFoodIds=[],t.forEach((e,t)=>{this.foods[e].visible=!0,this.foodGlowPads[e].visible=!0;let n=this.foodAnimations[e];if(n.currentTargetScale.set(.7,.7,.7),t<5){let e=-2.2+t*.65;n.currentTargetPos.set(-3.2,-.1,e),n.currentTargetRot.set(0,Math.PI/2,0)}else{let e=-2.2+(t-5)*.75;n.currentTargetPos.set(3.2,-.1,e),n.currentTargetRot.set(0,-Math.PI/2,0)}}),this.targetCameraPos.set(0,4.4,6),this.targetCameraLookAt.set(0,-.3,0)):e===`quiz`&&(this.plate.visible=!1,this.groundPlatform.visible=!1,this.shelves.forEach(e=>e.visible=!1),this.controls.autoRotate=!1,t.forEach(e=>{this.foods[e].visible=!1,this.foodGlowPads[e].visible=!1}),this.targetCameraPos.set(0,7,10),this.targetCameraLookAt.set(0,0,-2))}toggleFoodOnPlate(e){if(this.currentView!==`meal-builder`)return;let t=this.foodAnimations[e],n=this.selectedFoodIds.indexOf(e);if(n===-1)this.selectedFoodIds.push(e),this.rearrangePlateFoods(),t.currentTargetScale.set(.85,.85,.85);else{this.selectedFoodIds.splice(n,1);let r=Object.keys(this.foods).indexOf(e);if(t.currentTargetScale.set(.7,.7,.7),r<5){let e=-2.2+r*.65;t.currentTargetPos.set(-3.2,-.1,e),t.currentTargetRot.set(0,Math.PI/2,0)}else{let e=-2.2+(r-5)*.75;t.currentTargetPos.set(3.2,-.1,e),t.currentTargetRot.set(0,-Math.PI/2,0)}this.rearrangePlateFoods()}this.triggerClickPop(e)}rearrangePlateFoods(){let e=this.selectedFoodIds.length;if(e===0)return;let t=.65;this.selectedFoodIds.forEach((n,r)=>{let i=this.foodAnimations[n],a=r/e*Math.PI*2,o=Math.sin(a)*t,s=Math.cos(a)*t;i.currentTargetPos.set(o,-.2,s),i.currentTargetRot.set(0,a,0)})}triggerClickPop(e){let t=this.foodAnimations[e];if(t){let n=this.currentView===`meal-builder`?this.selectedFoodIds.includes(e)?.85:.7:1;t.currentScale.set(n*.35,n*.35,n*.35),t.scaleVelocity.set(0,0,0)}}onMouseMove(e){let t=this.renderer.domElement.getBoundingClientRect();this.mouse.x=(e.clientX-t.left)/t.width*2-1,this.mouse.y=-((e.clientY-t.top)/t.height)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);let n=[];Object.keys(this.foods).forEach(e=>{let t=this.foods[e];t.visible&&n.push(t)});let r=this.raycaster.intersectObjects(n,!0);if(r.length>0){let e=r[0].object;for(;e.parent&&!e.name;)e=e.parent;let t=e.name;if(this.hoveredFoodId!==t){if(this.hoveredFoodId=t,this.container.style.cursor=`pointer`,this.hoveredFoodId){let e=this.currentView===`meal-builder`?this.selectedFoodIds.includes(this.hoveredFoodId)?.85:.7:1;this.foodAnimations[this.hoveredFoodId].currentTargetScale.set(e*1.25,e*1.25,e*1.25)}this.onHoverCallback&&this.onHoverCallback(this.hoveredFoodId)}}else if(this.hoveredFoodId){let e=this.currentView===`meal-builder`?this.selectedFoodIds.includes(this.hoveredFoodId)?.85:.7:1;this.foodAnimations[this.hoveredFoodId].currentTargetScale.set(e,e,e),this.hoveredFoodId=null,this.container.style.cursor=`default`,this.onHoverCallback&&this.onHoverCallback(null)}}onMouseClick(){this.hoveredFoodId&&(this.triggerClickPop(this.hoveredFoodId),this.onClickCallback&&this.onClickCallback(this.hoveredFoodId))}onWindowResize(){this.camera.aspect=this.container.clientWidth/this.container.clientHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(this.container.clientWidth,this.container.clientHeight)}tick(){requestAnimationFrame(this.tick.bind(this));let e=performance.now()*.001,t=Math.min(.08,e-this.lastTime);this.lastTime=e;let n=e-this.startTime;this.camera.position.lerp(this.targetCameraPos,4*t),this.controls.target.lerp(this.targetCameraLookAt,4*t),this.controls.update(),this.currentView===`landing`&&this.plate&&(this.plate.rotation.y+=.08*t),Object.keys(this.foods).forEach(e=>{let r=this.foods[e];if(!r.visible)return;let i=this.foodAnimations[e],a=this.hoveredFoodId===e,o=-160*(i.currentScale.x-i.currentTargetScale.x)-11*i.scaleVelocity.x;i.scaleVelocity.x+=o*t,i.currentScale.x+=i.scaleVelocity.x*t;let s=-160*(i.currentScale.y-i.currentTargetScale.y)-11*i.scaleVelocity.y;i.scaleVelocity.y+=s*t,i.currentScale.y+=i.scaleVelocity.y*t;let c=-160*(i.currentScale.z-i.currentTargetScale.z)-11*i.scaleVelocity.z;i.scaleVelocity.z+=c*t,i.currentScale.z+=i.scaleVelocity.z*t,i.currentPos.lerp(i.currentTargetPos,8*t),r.position.copy(i.currentPos),r.scale.copy(i.currentScale),i.currentRot.x+=(i.currentTargetRot.x-i.currentRot.x)*6*t,i.currentRot.y+=(i.currentTargetRot.y-i.currentRot.y)*6*t,i.currentRot.z+=(i.currentTargetRot.z-i.currentRot.z)*6*t,r.rotation.set(i.currentRot.x,i.currentRot.y,i.currentRot.z);let l=this.currentView===`meal-builder`&&this.selectedFoodIds.includes(e);this.currentView===`landing`?(r.position.y=i.currentPos.y+Math.sin(n*i.bobSpeed+i.bobOffset)*.09,r.rotation.y+=i.rotSpeed*t):this.currentView===`meal-builder`&&!l?r.position.y=i.currentPos.y+Math.sin(n*.9+i.bobOffset)*.025:l&&(r.position.y=i.currentPos.y+Math.sin(n*1.3+i.bobOffset)*.018);let u=this.foodGlowPads[e];if(u){u.position.x=r.position.x,u.position.z=r.position.z;let t=this.selectedFoodIds.includes(e),i=this.currentView===`landing`;u.position.y=t||i?-.382:-.44;let o=(a?1.35:1)*(a?1+Math.sin(n*6)*.12:1);u.scale.set(o,o,1)}r.traverse(e=>{if(e.isMesh&&e.material&&e.material.userData){let t=e.material.userData.rimIntensity;t&&(t.value=a?.9+Math.sin(n*6)*.25:.4)}})}),this.renderer.render(this.scene,this.camera)}},sd=new class{constructor(){this.ctx=null,this.isMuted=!0,this.ambientInterval=null,this.chordIndex=0,this.chords=[[130.81,164.81,196,246.94,293.66],[174.61,220,261.63,329.63,392],[196,246.94,293.66,329.63,440],[220,261.63,329.63,392,493.88]]}init(){if(!this.ctx)try{let e=window.AudioContext||window.webkitAudioContext;this.ctx=new e}catch(e){console.warn(`Web Audio API is not supported in this browser.`,e)}}setMute(e){this.init(),this.ctx&&this.ctx.state===`suspended`&&this.ctx.resume(),this.isMuted=e,this.isMuted?this.stopAmbient():this.startAmbient()}toggleMute(){return this.setMute(!this.isMuted),this.isMuted}playClick(){if(this.isMuted||!this.ctx)return;this.init();let e=this.ctx.createOscillator(),t=this.ctx.createGain();e.type=`sine`,e.frequency.setValueAtTime(600,this.ctx.currentTime),e.frequency.exponentialRampToValueAtTime(100,this.ctx.currentTime+.08),t.gain.setValueAtTime(.05,this.ctx.currentTime),t.gain.exponentialRampToValueAtTime(.001,this.ctx.currentTime+.08),e.connect(t),t.connect(this.ctx.destination),e.start(),e.stop(this.ctx.currentTime+.09)}playCorrect(){if(this.isMuted||!this.ctx)return;this.init();let e=[261.63,329.63,392,523.25],t=this.ctx.currentTime;e.forEach((e,n)=>{let r=this.ctx.createOscillator(),i=this.ctx.createGain();r.type=`triangle`,r.frequency.setValueAtTime(e,t+n*.08),i.gain.setValueAtTime(0,t+n*.08),i.gain.linearRampToValueAtTime(.04,t+n*.08+.02),i.gain.exponentialRampToValueAtTime(.001,t+n*.08+.18),r.connect(i),i.connect(this.ctx.destination),r.start(t+n*.08),r.stop(t+n*.08+.2)})}playIncorrect(){if(this.isMuted||!this.ctx)return;this.init();let e=this.ctx.currentTime,t=this.ctx.createOscillator(),n=this.ctx.createGain(),r=this.ctx.createBiquadFilter();t.type=`sawtooth`,t.frequency.setValueAtTime(130,e),t.frequency.linearRampToValueAtTime(90,e+.25),r.type=`lowpass`,r.frequency.setValueAtTime(300,e),n.gain.setValueAtTime(.06,e),n.gain.exponentialRampToValueAtTime(.001,e+.25),t.connect(r),r.connect(n),n.connect(this.ctx.destination),t.start(e),t.stop(e+.26)}playVictory(){if(this.isMuted||!this.ctx)return;this.init();let e=this.ctx.currentTime;[{f:261.63,d:.1,t:0},{f:329.63,d:.1,t:.1},{f:392,d:.1,t:.2},{f:523.25,d:.15,t:.3},{f:392,d:.1,t:.45},{f:523.25,d:.4,t:.55}].forEach(t=>{let n=this.ctx.createOscillator(),r=this.ctx.createGain();n.type=`triangle`,n.frequency.setValueAtTime(t.f,e+t.t),r.gain.setValueAtTime(0,e+t.t),r.gain.linearRampToValueAtTime(.05,e+t.t+.02),r.gain.exponentialRampToValueAtTime(.001,e+t.t+t.d),n.connect(r),r.connect(this.ctx.destination),n.start(e+t.t),n.stop(e+t.t+t.d+.02)})}startAmbient(){if(this.stopAmbient(),this.isMuted||!this.ctx)return;let e=()=>{if(this.isMuted||!this.ctx)return;let e=this.ctx.currentTime,t=this.chords[this.chordIndex];this.chordIndex=(this.chordIndex+1)%this.chords.length;let n=this.ctx.createBiquadFilter();n.type=`lowpass`,n.frequency.setValueAtTime(500,e),n.Q.setValueAtTime(1,e);let r=this.ctx.createDelay();r.delayTime.setValueAtTime(.4,e);let i=this.ctx.createGain();i.gain.setValueAtTime(.3,e),t.forEach((t,a)=>{let o=this.ctx.createOscillator(),s=this.ctx.createGain(),c=e+a*.15;o.type=`sine`,o.frequency.setValueAtTime(t,c),s.gain.setValueAtTime(0,c),s.gain.linearRampToValueAtTime(.015,c+1.5),s.gain.exponentialRampToValueAtTime(1e-4,c+5),o.connect(n),n.connect(s),s.connect(this.ctx.destination),s.connect(r),r.connect(i),i.connect(this.ctx.destination),o.start(c),o.stop(c+5.5)})};e(),this.ambientInterval=setInterval(e,6e3)}stopAmbient(){this.ambientInterval&&=(clearInterval(this.ambientInterval),null)}},cd=class{constructor(){this.canvas=document.getElementById(`confetti-canvas`),this.ctx=this.canvas?this.canvas.getContext(`2d`):null,this.particles=[],this.active=!1,this.canvas&&(this.resize(),window.addEventListener(`resize`,()=>this.resize()))}resize(){this.canvas&&(this.canvas.width=window.innerWidth,this.canvas.height=window.innerHeight)}burst(){if(!this.canvas||!this.ctx)return;this.particles=[],this.active=!0;let e=[`#ff1a48`,`#22c55e`,`#f97316`,`#6366f1`,`#06b6d4`,`#eab308`],t=this.canvas.width/2,n=this.canvas.height*.45;for(let r=0;r<80;r++){let r=Math.random()*Math.PI*2,i=4+Math.random()*8;this.particles.push({x:t,y:n,vx:Math.cos(r)*i,vy:Math.sin(r)*i-3,size:6+Math.random()*8,color:e[Math.floor(Math.random()*e.length)],rotation:Math.random()*Math.PI*2,rotationSpeed:-.1+Math.random()*.2,opacity:1,gravity:.25})}this.tick()}tick(){if(!this.active||!this.canvas)return;this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height);let e=!1;this.particles.forEach(t=>{t.x+=t.vx,t.y+=t.vy,t.vy+=t.gravity,t.rotation+=t.rotationSpeed,t.opacity-=.016,t.opacity>0&&(e=!0,this.ctx.save(),this.ctx.translate(t.x,t.y),this.ctx.rotate(t.rotation),this.ctx.fillStyle=t.color,this.ctx.globalAlpha=t.opacity,this.ctx.fillRect(-t.size/2,-t.size/2,t.size,t.size),this.ctx.restore())}),e?requestAnimationFrame(()=>this.tick()):(this.active=!1,this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height))}},ld=new class{constructor(){this.questions=[],this.currentIndex=0,this.score=0,this.selectedOption=null,this.confetti=null,this.quizOverlay=null,this.questionEl=null,this.optionsContainerEl=null,this.progressTextEl=null,this.progressFillEl=null,this.feedbackEl=null,this.feedbackTextEl=null,this.nextBtn=null,this.resultsOverlay=null,this.scoreTextEl=null,this.resultsMsgEl=null,this.restartBtn=null}init(){this.quizOverlay||(this.quizOverlay=document.getElementById(`quiz-overlay`),this.questionEl=document.getElementById(`quiz-question`),this.optionsContainerEl=document.getElementById(`quiz-options`),this.progressTextEl=document.getElementById(`quiz-progress-text`),this.progressFillEl=document.getElementById(`quiz-progress-fill`),this.feedbackEl=document.getElementById(`quiz-feedback`),this.feedbackTextEl=document.getElementById(`quiz-feedback-text`),this.nextBtn=document.getElementById(`quiz-next-btn`),this.resultsOverlay=document.getElementById(`results-overlay`),this.scoreTextEl=document.getElementById(`results-score`),this.resultsMsgEl=document.getElementById(`results-message`),this.restartBtn=document.getElementById(`quiz-restart-btn`),this.confetti=new cd,this.nextBtn.addEventListener(`click`,()=>{sd.playClick(),this.nextQuestion()}),this.restartBtn.addEventListener(`click`,()=>{sd.playClick(),this.start()}))}start(){this.init();let e=[...id].sort(()=>.5-Math.random());this.questions=e.slice(0,10),this.currentIndex=0,this.score=0,this.quizOverlay.classList.remove(`hidden`),this.resultsOverlay.classList.add(`hidden`),this.renderQuestion()}renderQuestion(){let e=this.questions[this.currentIndex];this.selectedOption=null,this.feedbackEl.classList.add(`hidden`),this.nextBtn.disabled=!0,this.questionEl.textContent=e.question;let t=this.currentIndex+1;this.progressTextEl.textContent=`Question ${t} of 10`,this.progressFillEl.style.width=`${t/10*100}%`,this.optionsContainerEl.innerHTML=``,e.options.forEach((e,t)=>{let n=document.createElement(`button`);n.className=`quiz-option-btn`,n.innerHTML=`<span class="option-letter">${String.fromCharCode(65+t)}</span> <span class="option-text">${e}</span>`,n.addEventListener(`click`,()=>this.selectOption(t,n)),this.optionsContainerEl.appendChild(n)})}selectOption(e,t){if(this.selectedOption!==null)return;this.selectedOption=e;let n=this.questions[this.currentIndex],r=this.optionsContainerEl.querySelectorAll(`.quiz-option-btn`);e===n.answer?(this.score++,t.classList.add(`correct`),sd.playCorrect(),this.feedbackTextEl.innerHTML=`<span class="correct-text">🎉 Correct!</span><br>${n.explanation}`,this.confetti&&this.confetti.burst()):(t.classList.add(`incorrect`),r[n.answer].classList.add(`correct-highlight`),sd.playIncorrect(),this.feedbackTextEl.innerHTML=`<span class="incorrect-text">❌ Incorrect</span><br>${n.explanation}`),this.feedbackEl.classList.remove(`hidden`),this.nextBtn.disabled=!1,r.forEach(e=>e.style.pointerEvents=`none`)}nextQuestion(){this.currentIndex++,this.currentIndex<10?this.renderQuestion():this.finish()}finish(){this.quizOverlay.classList.add(`hidden`),this.resultsOverlay.classList.remove(`hidden`),this.scoreTextEl.textContent=`${this.score} / 10`;let e=``,t=`💪`;this.score===10?(e=`Nutritional Masterclass! Perfect Score! You know exactly how to fuel your body.`,t=`🥇`):this.score>=8?(e=`Excellent job! You have a solid understanding of healthy eating habits and the 50–25–25 Healthy Plate model.`,t=`🌟`):this.score>=6?(e=`Good effort! You know a lot, but could review some areas to improve your daily food choices.`,t=`🥗`):(e=`Keep practicing! Review the fun facts of the 3D foods on the landing screen and try again to level up.`,t=`🍎`),this.resultsMsgEl.innerHTML=`<div class="results-emoji">${t}</div><div>${e}</div>`,sd.playVictory()}},ud=new class{constructor(){this.selectedIds=[],this.builderOverlay=null,this.foodBadgesContainer=null,this.scoreCardOverlay=null,this.barVitamins=null,this.barCarbs=null,this.barProtein=null,this.barCalories=null,this.barSugar=null,this.shelfButtonsContainer=null}init(){this.builderOverlay=document.getElementById(`screen-builder`),this.foodBadgesContainer=document.getElementById(`builder-badges`),this.scoreCardOverlay=document.getElementById(`meal-score-overlay`),this.barVitamins=document.getElementById(`meter-vitamins`),this.barCarbs=document.getElementById(`meter-carbs`),this.barProtein=document.getElementById(`meter-protein`),this.barCalories=document.getElementById(`meter-calories`),this.barSugar=document.getElementById(`meter-sugar`),this.shelfButtonsContainer=document.getElementById(`builder-shelves-list`),document.getElementById(`builder-score-btn`).onclick=()=>{sd.playClick(),this.showScore()},document.getElementById(`score-close-btn`).onclick=()=>{sd.playClick(),this.scoreCardOverlay.classList.add(`hidden`)},document.getElementById(`builder-reset-btn`).onclick=()=>{sd.playClick(),this.reset()}}start(){this.init(),this.selectedIds=[],this.builderOverlay.classList.remove(`hidden`),this.scoreCardOverlay.classList.add(`hidden`),od.setView(`meal-builder`),this.renderShelfControls(),this.updateUI()}renderShelfControls(){this.shelfButtonsContainer.innerHTML=``,Object.keys(rd).forEach(e=>{let t=rd[e],n=document.createElement(`div`);n.className=`shelf-item-row`,n.id=`row-${e}`,n.innerHTML=`
        <span class="shelf-indicator" style="background-color: ${t.color}"></span>
        <span class="shelf-item-name">${t.name}</span>
        <button class="shelf-toggle-btn" id="btn-toggle-${e}">Add</button>
      `,n.querySelector(`.shelf-toggle-btn`).onclick=()=>{sd.playClick(),this.toggleFood(e)},this.shelfButtonsContainer.appendChild(n)})}toggleFood(e){od.toggleFoodOnPlate(e);let t=this.selectedIds.indexOf(e);t===-1?this.selectedIds.push(e):this.selectedIds.splice(t,1),this.updateUI()}updateUI(){Object.keys(rd).forEach(e=>{let t=document.getElementById(`btn-toggle-${e}`),n=document.getElementById(`row-${e}`);t&&n&&(this.selectedIds.includes(e)?(t.textContent=`Remove`,t.classList.add(`selected`),n.classList.add(`selected`)):(t.textContent=`Add`,t.classList.remove(`selected`),n.classList.remove(`selected`)))}),this.foodBadgesContainer.innerHTML=``,this.selectedIds.length===0?this.foodBadgesContainer.innerHTML=`<span class="empty-plate-text">Plate is empty. Click items from shelves to build your 50–25–25 plate!</span>`:this.selectedIds.forEach(e=>{let t=rd[e],n=document.createElement(`div`);n.className=`food-badge`,n.style.borderLeft=`4px solid ${t.color}`,n.innerHTML=`
          <span>${t.name}</span>
          <button class="badge-remove-btn" title="Remove from plate">&times;</button>
        `,n.querySelector(`.badge-remove-btn`).onclick=()=>{sd.playClick(),this.toggleFood(e)},this.foodBadgesContainer.appendChild(n)});let e=ad(this.selectedIds);this.updateMeters(e)}updateMeters(e){let t=e.nutrients,n=e.breakdown,r=Math.min(100,n.vegFruit/2*100),i=this.barVitamins.querySelector(`.meter-fill`);i.style.width=`${r}%`,this.barVitamins.querySelector(`.meter-val`).textContent=`${n.vegFruit} / 2 Servings`,r>=100?i.style.backgroundColor=`#22c55e`:r>0?i.style.backgroundColor=`#f59e0b`:i.style.backgroundColor=`#ef4444`;let a=Math.min(100,n.carbs/1*100),o=this.barCarbs.querySelector(`.meter-fill`);o.style.width=`${a}%`,this.barCarbs.querySelector(`.meter-val`).textContent=`${n.carbs} / 1 Serving`,n.carbs===1?o.style.backgroundColor=`#22c55e`:n.carbs>1?o.style.backgroundColor=`#f59e0b`:o.style.backgroundColor=`#ef4444`;let s=Math.min(100,n.protein/1*100),c=this.barProtein.querySelector(`.meter-fill`);c.style.width=`${s}%`,this.barProtein.querySelector(`.meter-val`).textContent=`${n.protein} / 1-2 Servings`,n.protein>=1&&n.protein<=2?c.style.backgroundColor=`#22c55e`:n.protein>2?c.style.backgroundColor=`#f59e0b`:c.style.backgroundColor=`#ef4444`;let l=t.calories||0,u=Math.min(100,l/550*100),d=this.barCalories.querySelector(`.meter-fill`);d.style.width=`${u}%`,this.barCalories.querySelector(`.meter-val`).textContent=`${l} kcal`,l>=350&&l<=650?d.style.backgroundColor=`#22c55e`:d.style.backgroundColor=`#f59e0b`;let f=parseFloat(t.sugar)||0,p=Math.min(100,f/25*100),m=this.barSugar.querySelector(`.meter-fill`);m.style.width=`${p}%`,this.barSugar.querySelector(`.meter-val`).textContent=`${f}g`,p>80?m.style.backgroundColor=`#ef4444`:p>50?m.style.backgroundColor=`#f59e0b`:m.style.backgroundColor=`#22c55e`}showScore(){let e=ad(this.selectedIds),t=document.getElementById(`score-grade`),n=document.getElementById(`score-summary`),r=document.getElementById(`score-tips`),i=document.getElementById(`score-number`);t.textContent=e.grade,t.style.color=e.color,i.textContent=`Score: ${e.score}/100`,n.textContent=e.summary,r.innerHTML=``,e.tips.forEach(e=>{let t=document.createElement(`li`);t.textContent=e,r.appendChild(t)}),this.scoreCardOverlay.classList.remove(`hidden`),e.score>=80?sd.playVictory():sd.playIncorrect()}reset(){[...this.selectedIds].forEach(e=>{od.toggleFoodOnPlate(e)}),this.selectedIds=[],this.updateUI()}},dd=`landing`,fd=document.getElementById(`tab-landing-btn`),pd=document.getElementById(`tab-quiz-btn`),md=document.getElementById(`tab-builder-btn`),hd=document.getElementById(`screen-landing`),gd=document.getElementById(`screen-quiz`),_d=document.getElementById(`screen-builder`),vd=document.getElementById(`audio-toggle-btn`),yd=document.getElementById(`food-card-modal`),bd=document.getElementById(`hover-label`);function xd(){let e=document.getElementById(`canvas-container`);od.init(e),od.onHoverCallback=Cd,od.onClickCallback=wd,fd.addEventListener(`click`,()=>Sd(`landing`)),pd.addEventListener(`click`,()=>Sd(`quiz`)),md.addEventListener(`click`,()=>Sd(`builder`)),document.getElementById(`start-quiz-hero`).addEventListener(`click`,()=>Sd(`quiz`)),document.getElementById(`start-builder-hero`).addEventListener(`click`,()=>Sd(`builder`)),vd.addEventListener(`click`,Ed),document.getElementById(`card-close-btn`).addEventListener(`click`,()=>{sd.playClick(),yd.classList.add(`hidden`)}),Sd(`landing`)}function Sd(e){sd.playClick(),dd=e,[fd,pd,md].forEach(e=>e.classList.remove(`active`)),[hd,gd,_d].forEach(e=>e.classList.add(`hidden`)),yd.classList.add(`hidden`),e===`landing`?(fd.classList.add(`active`),hd.classList.remove(`hidden`),od.setView(`landing`)):e===`quiz`?(pd.classList.add(`active`),gd.classList.remove(`hidden`),od.setView(`quiz`),ld.start()):e===`builder`&&(md.classList.add(`active`),_d.classList.remove(`hidden`),ud.start())}function Cd(e){if(dd!==`landing`){bd.classList.add(`hidden`);return}if(e){let t=rd[e];bd.textContent=`🔬 Click to inspect: ${t.name} (${t.group.toUpperCase()})`,bd.classList.remove(`hidden`)}else bd.textContent=`🔍 Hover over a 3D food item to inspect it`}function wd(e){dd===`landing`?Td(e):dd===`builder`&&ud.toggleFood(e)}function Td(e){let t=rd[e];if(!t)return;sd.playClick(),yd.className=`interactive-panel food-detail-card`,yd.classList.add(`card-${t.group}`),document.getElementById(`card-title`).textContent=t.name;let n=document.getElementById(`card-group-tag`);n.textContent=t.group,n.className=`group-tag tag-${t.group}`,document.getElementById(`card-tagline`).textContent=`"${t.tagline}"`;let r=t.nutrients;document.getElementById(`nut-calories`).textContent=`${r.calories} kcal`,document.getElementById(`nut-carbs`).textContent=r.carbs,document.getElementById(`nut-fiber`).textContent=r.fiber,document.getElementById(`nut-protein`).textContent=r.protein,document.getElementById(`nut-fat`).textContent=r.fat,document.getElementById(`nut-sugar`).textContent=r.sugar,document.getElementById(`nut-sodium`).textContent=r.sodium,document.getElementById(`nut-vitamins`).textContent=r.vitamins;let i=t.funFacts[Math.floor(Math.random()*t.funFacts.length)];document.getElementById(`card-fact-text`).textContent=i,yd.classList.remove(`hidden`)}function Ed(){sd.toggleMute()?(vd.innerHTML=`🔈 Sound Off`,vd.classList.remove(`sound-active`)):(vd.innerHTML=`🔊 Sound On`,vd.classList.add(`sound-active`),sd.playClick())}window.addEventListener(`DOMContentLoaded`,xd);